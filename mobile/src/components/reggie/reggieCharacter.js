 ...
 *
 * Ported verbatim from the "Regentify Brand" Claude Design project
 * (assets/reggie/reggie-character.js) so the app's mascot stays a single source
 * of truth with the design system. Same shape vocabulary as the app-icon mark
 * (one big eye, mortarboard cap, XP-yellow spikes + feet, mint belly), now a
 * full-body character with a working set of expressions.
 *
 * Each function returns an SVG *string*; render it through react-native-svg's
 * <SvgXml>. See ReggieMascot.jsx.
 */
