...
export default function AppNavigator() {
  ...
  useEffect(() => {
    if (!user) {
      setPetChosen(null); setSubjectChosen(null); setSchoolChosen(null)
      return
    }
    if (user.isAnonymous) {
    ...
    async function checkFlags() {
      try {
        ...
        setPetChosen(petDone); setSubjectChosen(subDone); setSchoolChosen(schDone)
      } catch {
        setPetChosen(false); setSubjectChosen(false); setSchoolChosen(false)
      }
    }
    checkFlags()
  }, [user])
  ...
  return (
    ...
    >
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        {/* Theme picker onboarding removed — dark by default */}
        {!user ? (
