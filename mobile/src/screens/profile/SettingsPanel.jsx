...
// The Settings panel of the combined Profile tab — account/preferences + actions.
// The identity header (avatar, level, streak) and the Progress dashboard live in
// the parent ProfileScreen / ProgressPanel, so this panel no longer renders them.
