  ...
  "questions": [
    {
      ...
      "explanation": "The Tokugawa shogunate ended the Sengoku (warring states) period and unified Japan under a centralized authority. This brought a long era of political stability and peace.",
      "diveDeep": "The Tokugawa shogunate established a system of centralized feudalism in Japan from 1603 to 1867, ending centuries of civil war. Under this regime, the daimyo (local lords) were strictly controlled through the alternate attendance system (sankin-kotai), and a rigid four-tier social structure was enforced. Wrong choices like promoting trade and modernizing industry are incorrect because the shogunate implemented the isolationist Sakoku policy, severely restricting foreign trade, and did not begin industrialization, which occurred later during the Meiji Restoration. Similar Regents questions often test the transition from Sengoku chaos to Tokugawa stability and subsequent socio-economic controls. The key takeaway is that political unification in Edo Japan was achieved at the cost of strict social control and isolationism.",
    ...
    },
    {
      ...
      "image": "/images/exams/global-history/january-2023/context_1_2.png",
      "context": "Base your answers to questions 1 and 2 on the passage below and on your knowledge of social studies.\\\\nThe Edo period followed many years of political and social upheaval. The previous division of\\\\nJapanese history known as the Sengoku period (warring states period) was dominated by wars\\\\nfought between various political and religious factions for the control of the country. These wars\\\\ncame to an end with the unifi cation of Japan by the great generals Oda Nobunaga and Toyotomi\\\\nHideyoshi and eventually Tokugawa Ieyasu who formed Japan’s fi nal Shogunate.\\\\nIeyasu consolidated his power through a series of social changes including the introduction of a\\\\nstrict class system and the tight control of the ruling daimyo families from the capital city Edo.\\\\nIndividuals had no legal rights and the family became very important at all social levels.…\\\\nSource: Hokusai online",
      "explanation": "The passage describes how Tokugawa Ieyasu consolidated power by introducing a strict class system and tightly controlling the daimyo from the capital, representing absolutism. This concentration of power in the hands of the shogun limited individual rights.",
      "diveDeep": "Absolutism is a political system in which a single ruler holds absolute power, which in Japan was manifested through the shogun's tight control over the daimyo and the entire social structure. During the Edo period, individual rights were non-existent, and the authority of the central shogunate was absolute. Other choices such as democracy, socialism, and oligarchy are historically inaccurate as democratic and socialist movements did not emerge until the late 19th and 20th centuries, and the system was a centralized shogunate rather than an oligarchy. Regents questions on the Tokugawa period frequently focus on the centralization of power, the reduction of daimyo autonomy, and the lack of individual liberties. The key takeaway is that the Tokugawa regime consolidated political power through absolute feudal authority and strict societal monitoring.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 3,
      ...
      "explanation": "The headlines focus on unfair taxation, economic uncertainty, and lack of equal representation, which were core grievances under the Old Regime that triggered the French Revolution. These structural inequalities created widespread discontent among the Third Estate.",
      "diveDeep": "The French Revolution (1789–1799) was caused by deep-seated issues within the Old Regime (Ancien Régime), particularly the inequality of the Three Estates where the Third Estate bore the tax burden with minimal representation. Wrong choices are historically incorrect because the Estates-General had not met for 175 years prior to 1789, King Louis XVI did not believe in the consent of the governed, and the Reign of Terror targeted citizens of all classes, not just the nobility and clergy. Regents questions on the French Revolution routinely ask about the causes of the revolution, centering on the unfair Estates system and financial crises. The key takeaway is that systemic social inequality and absolute monarchy drove the French population to overthrow the existing order.",
      "topic": "Themes & Review",
    ...
    },
    {
      ...
      "context": "Base your answers to questions 3 and 4 on the headlines below and on your knowledge of social studies.\\\\nHeadlines of the 18th Century\\\\nA. “Economic Uncertainty Grips Society”\\\\nB. “King Ignores Equal Representation For All”\\\\nC. “King Executed, Terror Begins”\\\\nD. “Tax System Seen As Unfair”",
      "explanation": "The radical stage of the French Revolution was characterized by the execution of King Louis XVI and the Reign of Terror led by Robespierre. This phase represented the peak of revolutionary violence and political extremism.",
      "diveDeep": "The radical phase of the French Revolution, spanning from 1792 to 1794, saw the rise of the Jacobins, the execution of the king, and the Reign of Terror where tens of thousands were guillotined. Other choices reflect the moderate phase or the pre-revolutionary crisis, such as the fiscal crisis (Headline A) and the demands for representation at the Estates-General (Headline B). Regents questions frequently test the progression of the French Revolution from moderate reforms to radical violence under the Committee of Public Safety. The key takeaway is that the radical phase of the revolution sought to secure its goals by systematically eliminating perceived internal enemies through state-sponsored terror.",
      "topic": "Themes & Review",
      "subTopic": "Imperialism & Industry"
    },
    {
      ...
      "explanation": "Both declarations assert that the fundamental purpose of political associations is the preservation of the natural and inalienable rights of individuals. They advocate for liberty, property, security, and resistance to oppression for all citizens.",
      "diveDeep": "During the French Revolution, the concept of citizenship was redefined to emphasize natural rights and equality before the law, inspired by Enlightenment philosophy. Wrong choices are historically incorrect because neither document addresses the banning of political parties, they advocate for secular sovereignty rather than religious control, and they do not seek to abolish all social/economic classes, only stating that social distinctions must be based on the general good. Regents questions often focus on the documents of the French Revolution as reflections of Enlightenment ideals and demands for civil rights. The key takeaway is that the revolutionary era established the protection of individual rights as the primary legitimacy of the state.",
      "topic": "Themes & Review"
    },
    {
      "number": 6,
      ...
      "image": "/images/exams/global-history/january-2023/context_5_6.png",
      "context": "Base your answers to questions 5 and 6 on the documents below and on your knowledge of social studies.\\\\nExcerpt from the Declaration of the Rights of Man and of the Citizen, 1789\\\\nArticles\\\\n1. Men are born and remain free and equal in rights. Social distinctions may be founded only\\\\nupon the general good.\\\\n2. The aim of all political association is the preservation of natural and imprescriptible [inalienable]\\\\nrights of man. These rights are liberty, property, security, and resistance to oppression.\\\\n3. The principle of all sovereignty resides essentially in the nation. No body nor individual may\\\\nexercise any authority which does not proceed directly from the nation.…\\\\nSource: The Avalon Project at Yale Law School\\\\nExcerpt from the Declaration of the Rights of Woman and Female Citizen, 1791\\\\nI. Woman is born free and remains equal to man in rights. Social distinctions can only be\\\\nfounded on common service.\\\\nII. The aim of all political associations is to preserve the natural and inalienable rights of Woman\\\\nand Man: these are rights to liberty, ownership, safety, and, above all, resistance to oppression.\\\\nIII. The principle of sovereignty resides in essence in the Nation, which is only the coming\\\\ntogether of Woman and Man: authority emanating elsewhere can be exercised by no body or\\\\nindividual.…\\\\nSource: Olympe de Gouges\\\\n",
      "explanation": "The emphasis on natural rights, including liberty, property, security, and resistance to oppression, directly derives from John Locke's political philosophy. Locke's social contract theory argued that government exists to protect these fundamental rights.",
      "diveDeep": "John Locke was a key Enlightenment philosopher whose ideas about natural rights and the social contract laid the foundations for modern democratic revolutions. Incorrect choices are historically wrong because Adam Smith was an economist focused on free-market capitalism, Catherine the Great was an enlightened despot who maintained autocracy in Russia, and Maximilien Robespierre was a radical leader associated with the Reign of Terror rather than the foundational declarations of 1789 and 1791. Regents questions consistently link the concept of 'natural rights' (life, liberty, property) to John Locke's influence on the American and French Revolutions. The key takeaway is that Enlightenment thought, particularly Lockean philosophy, provided the intellectual justification for challenging absolute monarchy.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 7,
      ...
      "explanation": "The passage outlines how King Leopold II of Belgium exploited the Congo for rubber to meet the demands of the bicycle and automobile industries, demonstrating the economic motivations of European imperialism. This shows how industrial demands in Europe drove the colonization of Africa.",
      "diveDeep": "The Scramble for Africa in the late 19th century was heavily driven by European industrial demands for raw materials, such as rubber, oil, and cotton, and new markets. Other choices are incorrect because the passage describes labor practices in the Congo rather than Europe, does not explain why Europeans wanted ivory (which was their previous export before rubber became the focus), and shows raw materials being exported from Africa to Europe, not imported to Africa. Regents questions on the Congo Free State and King Leopold II routinely emphasize the economic exploitation, forced labor, and human rights abuses that characterized Belgian rule. The key takeaway is that the Second Industrial Revolution directly accelerated the colonial conquest and economic exploitation of African territories.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 8,
      ...
      "image": "/images/exams/global-history/january-2023/context_7_8.png",
      "context": "Base your answers to questions 7 and 8 on the passage below and on your knowledge of social studies.\\\\n…Ivory and slaves had been the Congo’s main exports, but Leopold focused on rubber. The mass\\\\nmarketing of bicycles and automobiles in the 1890s greatly increased the demand for rubber and\\\\nsent prices soaring. When a rubber producing vine was discovered in the rainforests of Congo in\\\\n1890, Leopold forced out the competition and acquired a monopoly on the scarce commodity. By\\\\none estimate, the Congo was producing 20,000 tons of crude rubber a year at a 900 percent profi t.\\\\nThe high return was due largely to cheap labor.…\\\\nSource: Michael Parker, Mission Crossroads, Spring 2017",
      "explanation": "The Berlin Conference of 1884–1885 laid the ground rules for the division of Africa among European powers, allowing King Leopold II to claim the Congo Free State as his personal possession. This colonization enabled the brutal exploitation of Congolese labor for rubber extraction.",
      "diveDeep": "The Berlin Conference was convened by Otto von Bismarck to regulate European colonization and trade in Africa, resulting in the partition of the continent without African input. Wrong choices are historically incorrect because the British Abolition Act (1833) outlawed slavery in the British Empire, the Sadler Report (1832) investigated British child labor in factories, and the Napoleonic Code (1804) reformed the French legal system, none of which directly led to the colonization of the Congo. Regents exams frequently test the Berlin Conference as the catalyst for the 'Scramble for Africa' and the establishment of colonial borders. The key takeaway is that the Berlin Conference formalized European imperialism in Africa, leading to devastating impacts on local populations.",
    ...
    },
    {
      ...
      "explanation": "The Agrarian Revolution, through innovations like Jethro Tull's seed drill, increased food production, which improved survival rates and led to a rapid population increase. This demographic surge provided the workforce for the Industrial Revolution.",
      "diveDeep": "The Agricultural Revolution in 18th-century Britain led to increased food supply, reduced mortality rates, and rapid population growth, which subsequently fueled urbanization as farmers migrated to cities. Other choices are historically wrong because the period saw a migration of people from rural areas to cities (urbanization) rather than to rural areas, Marxist ideals developed much later in the mid-19th century as a critique of industrial capitalism, and the Irish Potato Famine was caused by a potato blight and British economic policy in the 1840s. Regents questions often connect the Agricultural Revolution directly to population growth and the subsequent rise of the industrial labor force. The key takeaway is that agricultural modernization was a crucial prerequisite for demographic expansion and industrialization.",
      "topic": "Document & Source Analysis",
      "subTopic": "Imperialism & Industry"
    },
    {
      ...
      "image": "/images/exams/global-history/january-2023/context_9_10.png",
      "context": "Base your answers to questions 9 and 10 on the passage below and on your knowledge of social studies.\\\\n…Equally important to English agriculture was the development of new ways of raising crops\\\\nand animals. About the same time that Townshend was experimenting with turnips and clover,\\\\nan English farmer, Jethro Tull, introduced a new way of planting seed. In the past, farmers had\\\\nscattered seed over the surface of a plowed fi eld. Much of this seed was eaten by birds or did not\\\\ntake root.\\\\n\\\\nTull instead proposed planting each seed deeply into the ground and then hoeing around it.\\\\nThe result was a heavy crop yield because more seeds survived and fl ourished. Tull increased the\\\\neffi ciency of this process by doing the planting with horse-drawn seed drills and hoes.…\\\\n\\\\nThis agrarian revolution, as it has been called, was every bit as important as the industrial\\\\nrevolution. The availability of good food, combined with improved infant survival and the\\\\ndisappearance of epidemics, helped more young live to adulthood and allowed adults to live\\\\nlonger. This meant that, by the middle of the eighteenth century, more people were having more\\\\nchildren, and the population grew quickly thereafter.…\\\\nSource: James A. Corrick, The Industrial Revolution, Lucent Books, 1998",
      "explanation": "The Green Revolution of the mid-20th century introduced high-yielding crop varieties, chemical fertilizers, and advanced irrigation, which led to a massive increase in global food production similar to the 18th-century Agrarian Revolution.",
      "diveDeep": "The Green Revolution, starting in the 1940s and 1950s led by Norman Borlaug, dramatically increased agricultural yields in developing countries using modern technologies. The wrong choices are incorrect because the Ukrainian Holodomor was a man-made famine in Soviet Ukraine, the desertification of the Sahara/Sahel represents a loss of arable land and decrease in agricultural capacity, and the construction of the Aswan Dam is an infrastructure project in Egypt that, while providing irrigation, did not represent a global agricultural revolution. Regents questions often compare the 18th-century Agrarian Revolution with the 20th-century Green Revolution as both used technology to increase crop yields. The key takeaway is that technological innovations in farming have repeatedly transformed human demographics by expanding food security and driving population growth.",
      "topic": "Document & Source Analysis",
      "subTopic": "Imperialism & Industry"
    },
    {
      ...
      "explanation": "Gandhi's spinning of yarn (khadi) symbolized self-reliance and the boycott of British-made textiles, which was a central strategy of the Indian independence movement.",
      "diveDeep": "Gandhi promoted the use of traditional homespun cloth (khadi) as a way to boycott imported British textiles, encouraging Indian self-reliance and economically hurting the British colonial system. Other choices are incorrect because appeasement refers to the pre-WWII policy of conceding to aggressive powers like Nazi Germany, containment was the Cold War strategy to stop the spread of communism, and segregation refers to racial separation policies. Regents questions often ask about Gandhi's methods of nonviolent resistance, including civil disobedience, boycotts, and the Salt March. The key takeaway is that Gandhi used economic boycotts and self-reliance as peaceful weapons to dismantle British colonial power.",
    ...
    },
    {
      ...
      "image": "/images/exams/global-history/january-2023/context_11_12.png",
      "context": "Base your answers to questions 11 and 12 on the photograph below and on your knowledge of social studies.\\\\nMahatma Gandhi Spinning Yarn in the Late 1920s\\\\nSource: Carnegie Council for Ethics in International Affairs, January 15, 1929",
      "explanation": "Gandhi's spinning of yarn was a direct reaction to British imperialism, which had destroyed India's domestic textile industry by flooding the market with British manufactured goods.",
      "diveDeep": "British colonial policy forced India to export raw cotton and import finished British textiles, decimating India's traditional cottage industries. Other choices are historically incorrect because Russia never successfully invaded South Asia, and the Cold War nonalignment movement occurred after India achieved independence in 1947. Regents questions frequently test how British economic policies (like mercantilism) led to Indian nationalism and resistance. The key takeaway is that the khadi movement was both an economic strategy and a political statement against colonial exploitation.",
      "topic": "Images & Political Cartoons"
    },
    {
      "number": 13,
      ...
      "explanation": "Kemal Atatürk implemented a series of reforms designed to secularize and westernize Turkey, which included restricting traditional religious attire like headscarves and promoting European-style dress.",
      "diveDeep": "Following the collapse of the Ottoman Empire, Mustafa Kemal Atatürk established the modern, secular Republic of Turkey and instituted sweeping reforms to modernize the nation along Western lines. Incorrect choices are historically wrong because Atatürk did not adopt anti-Semitism, he actively embraced modernization rather than rejecting it, and he sought to diminish, not promote, Islamic political and traditional influence in public life. Regents questions on Atatürk frequently focus on his secular reforms, the replacement of the Arabic script with the Latin alphabet, and the adoption of Western legal codes. The key takeaway is that Atatürk modernized Turkey by separating state institutions from Islamic traditions and aligning Turkish culture closer to European norms.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 14,
      ...
      "image": "/images/exams/global-history/january-2023/context_13_14.png",
      "context": "Base your answers to questions 13 and 14 on the passage below and on your knowledge of social studies.\\\\n…Lives were indeed about to be sacrifi ced for the sake of the hat. As for the veiling of women,\\\\nit was offi cially discouraged, but not banned. In any case, veiling had been largely a middle-class\\\\ncustom, and the middle classes discarded it. The generality of women wore long headscarves,\\\\nwhich they drew across their faces in the presence of male strangers. The government of the\\\\nrepublic banned headscarves in offi cial premises, including schools, under civil service regulations.\\\\nElsewhere they were tolerated and they have remained a feature of the Turkish scene to this day,\\\\nwhile the ban on women’s headscarves in offi cial premises is challenged every time that offi cial\\\\npressure is relaxed.…\\\\nSource: Andrew Mango, Atatürk, The Overlook Press",
      "explanation": "The passage notes that the ban on headscarves is challenged every time official pressure is relaxed, indicating that these secularizing reforms faced persistent resistance and were not universally accepted.",
      "diveDeep": "Although Atatürk's top-down reforms successfully westernized Turkey's state institutions, traditional and religious customs remained deeply rooted among many Turkish citizens, particularly in rural areas. Other choices are unsupported because the text explicitly states that headscarves were banned in schools (contradicting choice 1) and does not suggest that respect was specifically given to middle-class women over others (making choice 2 incorrect). Regents exams often emphasize that rapid modernization and secularization programs in the Middle East frequently faced cultural backlash and resistance from traditional populations. The key takeaway is that cultural changes imposed by government decree often meet long-term resistance from traditional sectors of society.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 15,
      ...
      "explanation": "The devastation of the Holocaust during World War II created massive international sympathy and urgency for the establishment of a Jewish homeland, directly leading to the 1947 United Nations Partition Plan.",
      "diveDeep": "The Zionist movement gained global support after World War II and the revelation of the Holocaust, in which six million Jews were systematically murdered by Nazi Germany. Incorrect choices are wrong because while Russian pogroms in the late 19th and early 20th centuries spurred early Zionist migration, they did not directly cause the 1947 plan; the fall of the Austro-Hungarian Empire and the Paris Peace Conference occurred after World War I, long before the UN plan was drafted. Regents questions on the creation of Israel frequently link the event to the aftermath of World War II, British withdrawal from the mandate, and the Holocaust. The key takeaway is that the tragedy of the Holocaust was a major catalyst for international backing of the UN Partition Plan.",
      "topic": "Themes & Review",
    ...
    },
    {
      ...
      "image": "/images/exams/global-history/january-2023/context_15_16.png",
      "context": "Base your answers to questions 15 and 16 on the maps below and on your knowledge of social studies.\\\\n50 km\\\\nGaza\\\\nJordan\\\\nAmman\\\\nAmman\\\\nAmman\\\\nWest\\\\nBank\\\\nJewish state\\\\nAccords after 1948 Arab-Israeli war:\\\\nJordan controls East Jerusalem\\\\nand West Bank.\\\\nEgypt controls Gaza.\\\\nArab state\\\\nUN administration\\\\nControlled partly by Israel,\\\\npartly by Palestinians\\\\nPalestinian control\\\\nUN control\\\\nSource: Daily Mail, February 18, 2017 (adapted)\\\\nBeersheba\\\\nEgypt\\\\nEilat\\\\nEilat\\\\nEilat\\\\nSinai\\\\nJordan\\\\nBeersheba\\\\nEgypt\\\\nSinai\\\\nJordan\\\\nBeersheba\\\\nEgypt\\\\nSinai\\\\nTel Aviv\\\\nHaifa\\\\nTel Aviv\\\\nHaifa\\\\nLebanon\\\\nSyria\\\\nLebanon\\\\nSyria\\\\nSyria\\\\nTel Aviv\\\\nGaza\\\\nStrip\\\\nGaza\\\\nStrip\\\\nDead\\\\nSea\\\\nDead\\\\nSea\\\\nDead\\\\nSea\\\\n50 km\\\\n50 km\\\\n1947 UN Partition Plan\\\\n,VUDHO·V\\\\u0003&KDQJLQJ\\\\u0003%RUGHUV\\\\n1949\\\\n2017\\\\nMap A\\\\n0DS\\\\u0003%\\\\n0DS\\\\u0003&\\\\nJerusalem\\\\nJerusalem\\\\nLebanon\\\\nEast Jerusalem\\\\nAnnexed by\\\\nIsrael 1980\\\\nWest\\\\nBank\\\\nGolan Heights\\\\nAnnexed by\\\\nIsrael in 1981\\\\nIsrael\\\\nIsrael\\\\nJerusalem\\\\n",
      "explanation": "Over the course of the Arab-Israeli conflicts from 1948 to the present, Israel expanded its territory, directly benefiting Zionists and Jewish immigrants who sought to establish and secure a Jewish state.",
      "diveDeep": "Following the 1948 Arab-Israeli War and the 1967 Six-Day War, Israel expanded its borders beyond the original 1947 UN Partition Plan, gaining control over the West Bank, Gaza Strip, and Golan Heights. Wrong choices are incorrect because the maps show Jordan losing control of the West Bank after 1948, Palestinian nationalists losing land and sovereignty, and Lebanon's citizens not gaining any territorial benefits. Regents questions on the Middle East often test the shifting borders of Israel and the ongoing territorial conflicts with neighboring Arab states and Palestinians. The key takeaway is that military conflicts in the region have led to a significant expansion of Israeli control at the expense of Palestinian self-determination.",
      "topic": "Themes & Review",
      "subTopic": "Ancient & Classical"
    },
    {
      ...
      "explanation": "President Ronald Reagan's speech at the Berlin Wall directly addresses the division between East and West during the Cold War. The Berlin Wall was a primary symbol of the division between the democratic West and the communist East.",
      "diveDeep": "The Cold War (1945–1991) was an era of geopolitical tension between the United States and the Soviet Union, with Berlin serving as a central focal point of this rivalry. Wrong choices are incorrect because World War I, the Russian Revolution, and World War II all predated the construction of the Berlin Wall in 1961. Regents questions on the Berlin Wall often focus on its role as a symbol of the 'Iron Curtain' and its fall in 1989 as the symbolic end of Soviet dominance in Eastern Europe. The key takeaway is that the Berlin Wall stood as the physical manifestation of the ideological conflict between capitalism and communism.",
      "topic": "Causation & Turning Points"
    },
    {
      "number": 18,
      ...
      "image": "/images/exams/global-history/january-2023/context_17_18.png",
      "context": "Base your answers to questions 17 and 18 on the speech excerpt below and on your knowledge of social\\\\nstudies.\\\\n…There is one sign the Soviets can make that would be unmistakable, that would advance\\\\ndramatically the cause of freedom and peace. General Secretary Gorbachev, if you seek peace,\\\\nif you seek prosperity for the Soviet Union and Eastern Europe, if you seek liberalization: Come\\\\nhere to this gate! Mr. Gorbachev, open this gate! Mr. Gorbachev, tear down this wall!…\\\\nSource: Ronald Reagan, “Remarks on East-West Relations at the Brandenburg Gate in West Berlin,” June 12, 1987\\\\n",
      "explanation": "The Berlin Wall was constructed by East Germany in 1961 to prevent its citizens from fleeing from the communist East to the democratic and capitalist West Berlin.",
      "diveDeep": "The Berlin Wall was erected by the Soviet-backed German Democratic Republic (East Germany) to halt the 'brain drain' of skilled workers migrating to West Germany. Wrong choices are historically incorrect because the wall was meant to suppress capitalism, not spread it, did not promote imperialism, and did not directly address military cooperation but rather acted as a physical barrier to migration. Regents exams frequently test the purpose of the Berlin Wall as a mechanism to stop East Germans from escaping to the West. The key takeaway is that the Berlin Wall was a repressive barrier designed to control populations and limit personal freedom.",
      "topic": "Causation & Turning Points"
    },
    {
      "number": 19,
      ...
      "explanation": "Nkrumah's speech was influenced by the history of European political and economic dominance in Africa, which he sought to overcome by advocating for decolonization and Pan-African unity.",
      "diveDeep": "Kwame Nkrumah was the leader of Ghana's independence movement and a prominent advocate of Pan-Africanism, which sought to unite newly independent African nations to resist neo-colonialism. Other choices are historically wrong because Africa was not undergoing rapid industrialization in 1961, Islamic republics were not a dominant political trend across the continent at the time, and Africans actively resisted, rather than supported, European colonial expansion. Regents questions on decolonization often highlight the leaders of independence movements, such as Nkrumah in Ghana and Jomo Kenyatta in Kenya, and their promotion of national and continental unity. The key takeaway is that the struggle against European imperialism fostered the development of Pan-African identity and the quest for political independence.",
      "topic": "Themes & Review"
    },
    {
      "number": 20,
      ...
      "explanation": "The 1970 cartoon reflects the enormous financial burden and dangerous instability of the nuclear arms race, which pressured both the United States and the Soviet Union to engage in arms control negotiations.",
      "diveDeep": "During the Cold War, the nuclear arms race reached a point of Mutually Assured Destruction (MAD), causing economic strain for both superpowers and leading to détente and the Strategic Arms Limitation Talks (SALT). Incorrect choices are incorrect because the cartoon does not state that the USSR had fewer weapons, does not make a comparison of exact costs, and citizens did not desire more weapons but rather feared nuclear annihilation. Regents questions on the Cold War arms race often highlight the transition from competition to negotiations like SALT I and II due to the unsustainable costs and danger. The key takeaway is that the threat of nuclear war and economic reality forced the superpowers to seek limits on their nuclear arsenals.",
      "topic": "Themes & Review"
    },
    {
      "number": 21,
      ...
      "image": "/images/exams/global-history/january-2023/context_20_21.png",
      "context": "Base your answers to questions 20 and 21 on the cartoon below and on your knowledge of social studies.\\\\nSource: A Cartoon History of United States Foreign Policy,\\\\n1776–1976\\\\n",
      "explanation": "The concerns depicted in the cartoon led directly to détente and the signing of the Strategic Arms Limitation Treaty (SALT I) in 1972, which capped the number of intercontinental ballistic missiles for both nations.",
      "diveDeep": "To reduce the danger of nuclear war and the financial burden of the arms race, the US and USSR signed the SALT treaties, marking a key period of détente. Wrong choices are historically incorrect because the Soviet Union did not sell nuclear weapons to India and Pakistan, the UN Security Council's power did not significantly increase due to this event, and China's acquisition of nuclear weapons occurred independently of US-Soviet arms control talks. Regents exams often test the outcomes of détente, specifically identifying SALT as the agreement that placed limits on superpower nuclear capabilities. The key takeaway is that the arms race eventually gave way to diplomatic agreements that restricted nuclear stockpiles.",
      "topic": "Images & Political Cartoons"
    },
    {
      "number": 22,
      ...
      "explanation": "Deng Xiaoping identifies how a strictly planned (command) economy had hampered the development of productive forces, resulting in a slow pace of economic growth that he sought to fix by introducing market elements.",
      "diveDeep": "After the death of Mao Zedong, Deng Xiaoping initiated the 'Four Modernizations' and economic reforms starting in 1978, moving China away from a strict Soviet-style command economy toward 'socialism with Chinese characteristics.' Incorrect choices are wrong because the passage does not discuss the poverty of factory workers or foreign domination, and Deng is criticizing the limitations of the planned economy, not the market economy. Regents questions on Deng Xiaoping typically focus on his introduction of capitalist reforms (such as Special Economic Zones and the responsibility system) to accelerate economic growth while maintaining political control. The key takeaway is that China's transition toward a mixed economy was driven by the failure of the command system to produce rapid economic development.",
      "topic": "Causation & Turning Points"
    },
    {
      "number": 23,
    ...
    },
    {
      ...
      "explanation": "Nelson Mandela's speech calls for a non-racial South Africa with universal suffrage, which directly targets the end of apartheid, the state-sponsored system of racial segregation and white minority rule.",
      "diveDeep": "Apartheid was a system of institutionalized racial segregation and discrimination enforced by the National Party government in South Africa from 1948 to 1994. Wrong choices are historically incorrect because self-determination was the goal Mandela was trying to achieve, forced migration was a tool used under apartheid but not the name of the overarching policy, and urbanization is a demographic shift rather than a policy of racial discrimination. Regents questions frequently test the role of Nelson Mandela, the African National Congress (ANC), and international pressure in dismantling the apartheid regime. The key takeaway is that the end of apartheid paved the way for democratic elections and equal rights for all South Africans.",
      "topic": "Document & Source Analysis"
    },
    {
      "number": 25,
      ...
      "image": "/images/exams/global-history/january-2023/context_24_25.png",
      "context": "Base your answers to questions 24 and 25 on the quotation below and on your knowledge of social studies.\\\\n…“Our march to freedom is irreversible. We must not allow fear to stand in our way. Universal\\\\nsuffrage on a common voters’ role in a united democratic and non-racial South Africa is the only\\\\nway to peace and racial harmony.”…\\\\nSource: Excerpt of Nelson Mandela’s speech upon his release from prison, February 11, 1990\\\\n",
      "explanation": "Mandela's successful campaign for universal suffrage led to South Africa's first multi-racial democratic elections in 1994, which ended decades of white minority political control and elected Mandela as president.",
      "diveDeep": "The transition to universal suffrage allowed the black majority, who made up most of the population but had been disenfranchised, to vote, resulting in the election of the African National Congress. Other choices are historically wrong because there was no mass emigration of the population, South Africa was already a member of the United Nations (though suspended from the General Assembly due to apartheid), and there was no widespread confiscation of private farms at the end of apartheid. Regents exams often test the significance of the 1994 election as the turning point that established democratic majority rule in South Africa. The key takeaway is that democratic expansion and voting rights were key to dismantling minority control and achieving racial equality.",
      "topic": "Causation & Turning Points"
    },
    {
      "number": 26,
      ...
      "explanation": "The map displays trade data, specifically the import of clothing items from various countries, which is a major topic of study for economists analyzing global trade patterns and manufacturing.",
      "diveDeep": "Economics is the social science that studies the production, distribution, and consumption of goods and services, including international trade and labor markets. Incorrect choices are wrong because anthropologists study human cultures and development, historians study past events and historical documents, and sociologists focus on social behavior and society, making them less directly concerned with import/export percentages. Regents questions frequently test the definitions and tools used by different social scientists, such as geographers, economists, and archaeologists. The key takeaway is that trade flows, manufacturing statistics, and import data are key resources for economic analysis.",
    ...
    },
    {
      ...
      "image": "/images/exams/global-history/january-2023/context_26_28.png",
      "context": "Base your answers to questions 26 through 28 on the map below and on your knowledge of social studies.\\\\nWhere Your Clothes Were Made\\\\nIn 2016, the United States imported almost 27 billion articles of clothing. Here are the top\\\\n10 countries those clothes came from.\\\\nSource: New York Times Upfront Magazine",
      "explanation": "The map shows that the top exporters of clothing to the United States include major Asian nations such as China, Vietnam, Bangladesh, and India, demonstrating that US clothing imports are concentrated in Asia.",
      "diveDeep": "Globalization has shifted manufacturing to Asian countries due to lower labor costs, making them the primary suppliers of consumer goods like clothing to Western markets. Wrong choices are incorrect because the map shows no African countries in the top exporters, Asian nations clearly have the technology to manufacture massive amounts of goods, and Central America is not shown as importing clothing from India. Regents questions on globalization often focus on the interdependence of nations, outsourcing, and the concentration of manufacturing in East and South Asia. The key takeaway is that modern global supply chains are heavily centered on Asian manufacturing hubs.",
      "topic": "Maps & Geography"
    },
    {
      "number": 28,
      ...
      "image": "/images/exams/global-history/january-2023/context_26_28.png",
      "context": "Base your answers to questions 26 through 28 on the map below and on your knowledge of social studies.\\\\nWhere Your Clothes Were Made\\\\nIn 2016, the United States imported almost 27 billion articles of clothing. Here are the top\\\\n10 countries those clothes came from.\\\\nSource: New York Times Upfront Magazine",
      "explanation": "China's dominant share of clothing exports to the US indicates that its governmental policies, such as the creation of Special Economic Zones and export subsidies, actively support manufacturing for international markets.",
      "diveDeep": "Under Deng Xiaoping and subsequent leaders, China adopted export-oriented industrialization, utilizing government support, investment in infrastructure, and low labor costs to become the 'world's factory.' Wrong choices are historically incorrect because Chinese manufacturing growth was historically accompanied by weak enforcement of labor regulations and significant environmental degradation, rather than strict protections. Regents questions on modern China frequently address how government economic policies transformed China into a global economic superpower. The key takeaway is that government initiative and policy are critical drivers of a nation's success in global export markets.",
      "topic": "Maps & Geography"
    },
    {
      "number": 29,
