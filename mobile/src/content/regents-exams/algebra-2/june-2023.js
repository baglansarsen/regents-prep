  ...
  "questions": [
    {
      "number": 1,
      "part": "A",
      "text": "The population of Austin, Texas from 1850 to 2010 is summarized in the table below. (Year/Population pairs: 1850→629, 1870→4428, 1890→14,575, 1910→29,860, 1930→53,120, 1950→132,459, 1970→251,808, 1990→494,290, 2010→790,390.) Over which period of time was the average rate of change in population the greatest?",
      "choices": [
        "1850 to 1910",
        "1950 to 1970",
        "1990 to 2010",
      ...
      "correct": 2,
      "image": "/images/exams/alg2-june-2023/q1.png",
    ...
    },
    {
      "number": 2,
      "part": "A",
      "text": "Which expression is not equivalent to 36x⁶ − 25y⁴?",
      "choices": [
        "6²(x³)² − 5²(y²)²",
        "(6x³ − 5y²)(6x³ + 5y²)",
        "(6x⁶ − 5y⁴)(6x⁶ + 5y⁴)",
    ...
    },
    {
      "number": 3,
      "part": "A",
      "text": "What are the zeros of p(x) = x⁴ + 3x³ − 19x² − 27x + 90? (Equivalently, x⁴ − 9x² + 3x³ − 27x − 10x² + 90.)",
      "choices": [
        "{−3, −2, 5}",
        "{−3, −2, 3, 5}",
        "{−2, 3, 5}",
    ...
    },
    {
      "number": 4,
      "part": "A",
      "text": "If θ is an angle in standard position whose terminal side passes through the point (−2, 2√3), what is the numerical value of tan θ?",
      "choices": [
        "√3",
        "−√3",
        "√3 / 3",
    ...
    },
    {
      "number": 5,
      "part": "A",
      "text": "The average monthly temperature, T(m), in degrees Fahrenheit, over a 12-month period, can be modeled by T(m) = 23 cos((π/6)m) + 56, where m is in months. What is the amplitude of this function?",
      "choices": [
        "12",
        "23",
        "56",
    ...
    {
      "number": 6,
      "image": "/images/exams/alg2-june-2023/q6.png",
      "part": "A",
      "text": "Using the model T(m) = 23 cos((π/6)m) + 56, where m is in months, what is the range of temperatures, in degrees Fahrenheit, of this function?",
      "choices": [
        "[23, 79]",
        "[23, 56]",
        "[33, 79]",
    ...
    },
    {
      "number": 7,
      "part": "A",
      "text": "The expression 3i(ai − 6i²) is equivalent to",
      "choices": [
        "3a + 18i",
        "−3a + 18i",
        "3a − 18i",
    ...
    },
    {
      "number": 8,
      "part": "A",
      "text": "A logarithmic function h(x) is graphed with a vertical asymptote at x = −a and passing through certain points (graph shown). Which equation best represents the graph?",
      "choices": [
        "h(x) = log(x + a) + c",
        "h(x) = log(x + a) − c",
        "h(x) = log(x − a) + c",
      ...
      "topic": "Exponential & Logarithmic",
      "correct": 0,
      "image": "/images/exams/alg2-june-2023/q8.png",
    ...
    },
    {
      "number": 9,
      "part": "A",
      "text": "Which function has the end behavior described by: as x → ∞, f(x) → ∞ and as x → −∞, f(x) → 0?",
      "choices": [
        "f(x) = x²",
        "f(x) = −2ˣ",
        "f(x) = 5",
    ...
    },
    {
      "number": 10,
      "part": "A",
      "text": "The expression (x² + 3)² − 2(x² + 3) − 24 is equivalent to",
      "choices": [
        "(x² + 9)(x² − 1)",
        "x⁴ + 4x² − 9",
        "(x² − 3)(x² + 7)",
    ...
    },
    {
      "number": 12,
      "part": "A",
      "text": "The roots of the equation x² − 4x = −13 are",
      "choices": [
        "2 ± 3i",
        "2 ± √17",
        "2 ± 6i",
    ...
    },
    {
      "number": 13,
      "part": "A",
      "text": "Which expression is equivalent to (2x³ + 2x − 7) / (2x + 4)?",
      "choices": [
        "x² − 2x + 5 − 27/(2x + 4)",
        "x² + 2x + 5 + 13/(2x + 4)",
        "x² − 1 + 3/(2x + 4)",
    ...
    },
    {
      "number": 14,
      "part": "A",
      "text": "A popular celebrity tracks the number of people, in thousands, who have followed her on social media since January 1, 2015. She uses an exponential regression equation to model the data. According to the model, about how many followers did she have on June 1, 2018 (about 41 months after January 2015)?",
      "choices": [
        "13,000,000",
        "1,850,000",
        "5,420,000",
      ...
      "topic": "Exponential & Logarithmic",
      "correct": 2,
      "image": "/images/exams/alg2-june-2023/q14.png",
    ...
    },
    {
      "number": 15,
      "part": "A",
      "text": "Luminescence is the emission of light that is not caused by heat. A luminescent substance decays according to I = I₀·e^(−0.6·3t). This function can be best approximated by",
      "choices": [
        "I = I₀·e^(0.18t)",
        "I = I₀(0.0067)ᵗ",
        "I = I₀·e^(5t)",
    ...
    },
    {
      "number": 16,
      "part": "A",
      "text": "The heights of the students at Central High School can be modeled by a normal distribution with a mean of 68.1 and a standard deviation of 3.4 inches. According to this model, approximately what percent of the students would have a height less than 60 inches or greater than 75 inches?",
      "choices": [
        "0.86%",
        "2.12%",
        "1.26%",
    ...
    },
    {
      "number": 17,
      "part": "A",
      "text": "Marissa and Sydney randomly surveyed 100 members of the senior class; 43% said they would be interested in a senior musical. They then ran a simulation of 500 more surveys, each of 100 seniors, assuming 43% interest. Based on the simulation output (a dot plot of sample proportions), the standard deviation of the simulation is closest to",
      "choices": [
        "0.02",
        "0.09",
        "0.05",
      ...
      "topic": "Statistics & Probability",
      "correct": 2,
      "image": "/images/exams/alg2-june-2023/q17.png",
    ...
    },
    {
      "number": 18,
      "part": "A",
      "text": "For f(x) = cos x, which statement is true?",
      "choices": [
        "2f(x) and f(2x) are even functions.",
        "f(2x) and f(x) − 1 are odd functions.",
        "2f(x) and f(π − x) are odd functions.",
        "f(x) − 1 is an odd function and f(π − x) is an even function."
      ],
      "topic": "Trigonometric Functions",
      "correct": 0,
    ...
    },
    {
      "number": 19,
      "part": "A",
      "text": "The solution set of (x + 3)/(x − 5) + 6/(x + 2) = (10x + 5)/((x − 5)(x + 2)) is",
      "choices": [
        "{−6}",
        "{−6, 5}",
        "{5}",
    ...
    },
    {
      "number": 20,
      "part": "A",
      "text": "Given x and y are positive, which expressions are equivalent to x³√y ? I. (y/x⁶)^(−1/2)·... II. (y^(−1)·x⁹)^(1/... III. ⁴√(x³y³·x⁶y⁵)",
      "choices": [
        "I and II, only",
        "II and III, only",
        "I and III, only",
    ...
    },
    {
      "number": 21,
      "part": "A",
      "text": "Given the inverse function f⁻¹(x) = −(3/x) + 1/6, which function represents f(x)? (Equivalently f⁻¹(x) = (−x + 1)/6 form on the exam.)",
      "choices": [
        "f(x) = −(2/3)x + 1/6",
        "f(x) = (3 − x)/2 + 4",
        "f(x) = −3x + 1/4 (i.e., f(x) = (−x)/3 + 1/... )",
        "f(x) = (3 − x)/2 + 6"
      ],
      "topic": "Functions",
      "correct": 2,
    ...
    },
    {
      "number": 22,
      "part": "A",
      "text": "How many of the equations below are identities? • x² + y² = (x² − y²)² + (2xy)² • x³ + y³ = (x − y)(x² − xy + y²) • x⁴ + y⁴ = (x − y)(x − y)(x² + y²)",
      "choices": [
        "1",
        "3",
        "2",
    ...
    },
    {
      "number": 23,
      "part": "A",
      "text": "If the focus of a parabola is (0, 6) and the directrix is y = 4, what is an equation for the parabola?",
      "choices": [
        "y² = 4(x − 5)",
        "x² = 8(y − 5)",
        "x² = 4(y − 5)",
    ...
    },
    {
      "number": 24,
      "part": "A",
      "text": "John and Margaret deposit $500 into a savings account for their son on his first birthday. They continue to make a $500 deposit on each birthday, with the last deposit on the child's 21st birthday. If the account pays 4% annual interest, which equation represents the amount of money in the account after the last deposit is made?",
      "choices": [
        "S₂₁ = 500(1.04)²¹",
        "S₂₁ = 500(1 − 1.04²¹)/(1 − 1.04)",
        "S₂₁ = 500(1.04)²⁰ + 500",
    ...
    {
      "number": 32,
      "image": "/images/exams/alg2-june-2023/q32.png",
      "part": "B",
      "type": "written",
