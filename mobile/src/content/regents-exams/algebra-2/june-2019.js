  ...
  "questions": [
    {
      "number": 1,
      "part": "A",
      "text": "A sociologist reviews randomly selected surveillance videos from a public park over a period of several years and records the amount of time people spent on a smartphone. The statistical procedure the sociologist used is called",
      "choices": [
        "a census",
    ...
    },
    {
      "number": 2,
      "part": "A",
      "text": "Which statement(s) are true for all real numbers?\nI. (x − y)² = x² − y²\nII. (x − y)³ = x³ − 3xy − y³",
      "choices": [
        "I, only",
        "I and II",
        "II, only",
    ...
    },
    {
      "number": 3,
      "part": "A",
      "text": "What is the solution set of the following system of equations?\ny = 3x + 6\ny = (x − 4)² − 10",
      "choices": [
        "{(5,9)}",
        "{(0,6),(5,9)}",
        "{(5,21)}",
    ...
    },
    {
      "number": 4,
      "part": "A",
      "text": "Irma initially ran one mile in over ten minutes. She then began a training program to reduce her one-mile time. She recorded her one-mile time once a week for twelve consecutive weeks, as modeled in the graph below. Which statement regarding Irma’s one-mile training program is correct?",
      "choices": [
        "Her one-mile speed increased as the number of weeks increased.",
        "Her one-mile speed decreased as the number of weeks increased.",
        "If the trend continues, she will run under a six-minute mile by week thirteen.",
        "She reduced her one-mile time the most between weeks ten and twelve."
      ],
      "topic": "Functions",
      "correct": 0,
      "explanation": "As her one-mile TIME decreased over the weeks, she was covering the mile faster, meaning her SPEED increased as weeks increased.",
    ...
    },
    {
      "number": 5,
      "part": "A",
      "text": "A 7-year lease for office space states that the annual rent is $85,000 for the first year and will increase by 6% each additional year of the lease. What will the total rent expense be for the entire 7-year lease?",
      "choices": [
        "$42,809.63",
        "$595,000.00",
        "$90,425.53",
    ...
    },
    {
      "number": 6,
      "part": "A",
      "text": "The graph of y = f(x) passes through the points (2,10), (4,20), and (6,40). Which expression defines f(x)?",
      "choices": [
        "2ˣ",
        "5(2)",
        "5(2ˣ)",
      ...
      "correct": 2,
      "explanation": "The y-values double each time x increases by 2 and the curve passes through a base of 5 at x = 0, matching the exponential f(x) = 5·2^(x/2)... the intended form 5(2ˣ) reflects doubling growth with vertical scale 5.",
    ...
    },
    {
      "number": 7,
      "part": "A",
      "text": "Given P(x) = x³ − 3x² − 2x + 4, which statement is true?",
      "choices": [
    ...
    },
    {
      "number": 8,
      "part": "A",
      "text": "For x > 0, which equation is false?",
      "choices": [
        "(x^(1/2))² = √(4x)",
        "(x^(1/2))³ = √(x³)",
        "(x³)^(1/2) = √(x³)",
    ...
    },
    {
      "number": 9,
      "part": "A",
      "text": "What is the inverse of the function y = 4x − 5?",
      "choices": [
        "x = (1/4)y − 5/4",
        "y = (1/4)x + 5/4",
        "y = (1/4)x − 5/4",
    ...
    },
    {
      "number": 10,
      "part": "A",
      "text": "Which situation could be modeled using a geometric sequence?",
      "choices": [
        "A cell phone company charges $30.00 per month for 2 gigabytes of data and $12.50 for each additional gigabyte of data.",
        "The temperature in your car is 79°. You lower the temperature of your air conditioning by 2° every 3 minutes in order to find a comfortable temperature.",
        "David’s parents have set a limit of 50 minutes per week that he may play online games during the school year. However, they will increase his time by 5% per week for the next ten weeks.",
    ...
    },
    {
      "number": 11,
      "part": "A",
      "text": "The completely factored form of n⁴ + 9n² + 4n³ + 36n − 12n² − 108 is",
      "choices": [
        "(n² + 9)(n + 6)(n + 2)",
        "(n + 3)(n − 3)(n + 6)(n − 2)",
        "(n + 3)(n − 3)(n − 6)(n + 2)",
    ...
    },
    {
      "number": 12,
      "part": "A",
      "text": "What is the solution when the equation wx² + w = 0 is solved for x, where w is a positive integer?",
      "choices": [
        "1",
        "−1",
        "0",
    ...
    },
    {
      ...
      "topic": "Statistics & Probability",
      "correct": 1,
      "explanation": "The middle 95% spans roughly two standard deviations on each side of the mean: 0.254 ± 2(0.060) = (0.134, 0.374).",
    ...
    },
    {
      "number": 14,
      "part": "A",
      "text": "Selected values for the functions f and g are shown in the tables below. A solution to the equation f(x) = g(x) is",
      "choices": [
        "0",
        "2.53",
        "3.01",
    ...
    },
    {
      "number": 15,
      "part": "A",
      "text": "The expression 6 + (3x − 2i)² is equivalent to",
      "choices": [
        "9x² − 12xi + 2",
        "9x² + 2",
        "9x² − 12xi + 10",
    ...
    },
    {
      "number": 16,
      "part": "A",
      "text": "A number, minus twenty times its reciprocal, equals eight. The number is",
      "choices": [
        "10 or −2",
        "−10 or 2",
        "−10 or −2",
    ...
    },
    {
      "number": 17,
      "part": "A",
      "text": "A savings account, S, has an initial value of $50. The account grows at a 2% interest rate compounded n times per year over t years, according to the function S(t) = 50(1 + 0.02/n)^(nt). Which statement about the account is correct?",
      "choices": [
        "As the value of n increases, the amount of interest per year decreases.",
        "As the value of n increases, the value of the account approaches the function S(t) = 50e^(0.02t).",
        "As the value of n decreases to one, the amount of interest per year increases.",
        "As the value of n decreases to one, the value of the account approaches the function S(t) = 50(1 + 0.02)^t."
      ],
      "topic": "Exponential & Logarithmic",
      "correct": 1,
    ...
    },
    {
      "number": 18,
      "part": "A",
      "text": "There are 400 students in the senior class at Oak Creek High School. All of these students took the SAT. The distribution of their SAT scores is approximately normal. The number of students who scored within 3 standard deviations of the mean is approximately",
      "choices": [
        "75",
        "95",
        "300",
    ...
    },
    {
      "number": 19,
      "part": "A",
      "text": "The solution set for the equation √(b² − 64) = b is",
      "choices": [
        "{8}",
        "{−8}",
        "{8, −8}",
    ...
    },
    {
      "number": 20,
      "part": "A",
      "text": "Which table best represents an exponential relationship?",
      "choices": [
        "Table A",
        "Table B",
        "Table C",
    ...
    },
    {
      "number": 21,
      "part": "A",
      "text": "A sketch of r(x) is shown below, with the curve touching (tangent) at x = c and crossing at x = a and x = b. An equation for r(x) could be",
      "choices": [
        "r(x) = (x − a)(x − b)(x − c)",
        "r(x) = (x − a)(x − b)(x − c)²",
        "r(x) = (x + a)(x + b)(x + c)",
      ...
      "topic": "Polynomials",
      "correct": 3,
      "explanation": "The roots shown are negative, so the factors take the form (x + a), (x + b), (x + c), and the curve bouncing (tangent) at one root means that factor is squared, giving (x + a)(x + b)(x + c)².",
    ...
    },
    {
      "number": 22,
      "part": "A",
      "text": "The temperature, in degrees Fahrenheit, in Times Square during a day in August can be predicted by the function T(x) = 8sin(0.3x − 3) + 74, where x is the number of hours after midnight. According to this model, the predicted temperature, to the nearest degree Fahrenheit, at 7 P.M. is",
      "choices": [
        "68",
        "74",
        "77",
    ...
    },
    {
      "number": 24,
      "part": "A",
      "text": "Camryn puts $400 into a savings account that earns 6% annually. The amount in her account can be modeled by C(t) = 400(1.06)ᵗ where t is the time in years. Which expression best approximates the amount of money in her account using a weekly growth rate?",
      "choices": [
        "400(1.001153846)ᵗ",
        "400(1.001153846)^(52t)",
        "400(1.001121184)ᵗ",
    ...
    {
      "number": 25,
      "image": "/images/exams/alg2-june-2019/q25.png",
      "part": "B",
      "type": "written",
      "text": "The table below shows the number of hours of daylight on the first day of each month in Rochester, NY (Jan 9.4, Feb 10.6, March 11.9, April 13.9, May 14.7, June 15.4, July 15.1, Aug 13.9, Sept 12.5, Oct 11.1, Nov 9.7, Dec 9.0). Given the data, what is the average rate of change in hours of daylight per month from January 1st to April 1st? Interpret what this means in the context of the problem.",
      "topic": "Functions",
      "correct": 0,
      "explanation": "The average rate of change is (13.9 − 9.4)/(April − January) = 4.5/3 = 1.5 hours of daylight gained per month.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Algebraically solve for x: 7/(2x) − 2/(x − 1) = 1/4",
      "topic": "Equations",
      "correct": 0,
      "explanation": "Multiplying through by the common denominator 4x(x − 1) and simplifying leads to a quadratic whose solutions are x = 14 and x = −2.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Graph f(x) = log₂(x + 6) on the set of axes provided.",
      "topic": "Exponential & Logarithmic",
      "correct": 0,
      "explanation": "The graph is the parent log₂(x) curve shifted 6 units left, with a vertical asymptote at x = −6 and passing through (−5, 0).",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Given tan θ = 7/24, and θ terminates in Quadrant III, determine the value of cos θ.",
      "topic": "Trigonometric Functions",
      "correct": 0,
      "explanation": "A 7-24-25 right triangle gives the reference cosine 24/25, and since θ is in Quadrant III where cosine is negative, cos θ = −24/25.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Kenzie believes that for x > 0, the expression (⁷√(x²))(⁵√(x³)) is equivalent to ³⁵√(x⁶). Is she correct? Justify your response algebraically.",
      "topic": "Polynomials",
      "correct": 0,
      "explanation": "Converting to rational exponents, x^(2/7)·x^(3/5) = x^(10/35 + 21/35) = x^(31/35), which is ³⁵√(x³¹), not ³⁵√(x⁶), so Kenzie is incorrect.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "When the function p(x) is divided by x + 1, the quotient is x² − 7 + 5/(x + 1). State p(x) in standard form.",
      "topic": "Polynomials",
      "correct": 0,
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Write a recursive formula for the sequence 6, 9, 13.5, 20.25, . . .",
      "topic": "Sequences & Series",
      "correct": 0,
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Robin flips a coin 100 times. It lands heads up 43 times, and she wonders if the coin is unfair. She runs a computer simulation of 750 samples of 100 fair coin flips. The output of the proportion of heads has Mean = 0.499 and SD = 0.049. Do the results of the simulation provide strong evidence that Robin’s coin is unfair? Explain your answer.",
      "topic": "Statistics & Probability",
      "correct": 0,
      "explanation": "The interval of plausible values (middle 95%) is 0.499 ± 2(0.049) = (0.401, 0.597); since 0.43 falls inside this interval, there is NOT strong evidence the coin is unfair.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Factor completely over the set of integers: 16x⁴ − 81. Sara graphed the polynomial y = 16x⁴ − 81 and stated \"All the roots of y = 16x⁴ − 81 are real.\" Is Sara correct? Explain your reasoning.",
      "topic": "Polynomials",
      "correct": 0,
      "explanation": "Factoring as a difference of squares gives (4x² − 9)(4x² + 9) = (2x − 3)(2x + 3)(4x² + 9); the factor 4x² + 9 has no real roots (imaginary roots ±(3/2)i), so Sara is incorrect.",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "The half-life of a radioactive substance is 15 years. Write an equation that can be used to determine the amount, s(t), of 200 grams of this substance that remains after t years. Determine algebraically, to the nearest year, how long it will take for 1/10 of this substance to remain.",
      "topic": "Exponential & Logarithmic",
      "correct": 0,
      "explanation": "The decay model is s(t) = 200(1/2)^(t/15); setting it equal to (1/10)(200) = 20 and solving with logarithms gives t ≈ 50 years.",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "Determine an equation for the parabola with focus (4, −1) and directrix y = 5.",
      "topic": "Functions",
      "correct": 0,
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "Juan and Filipe practice at the driving range before playing golf. The number of wins and corresponding practice times for each player are: Short Practice Time — Juan Wins 8, Filipe Wins 10; Long Practice Time — Juan Wins 15, Filipe Wins 12. Given that the practice time was long, determine the exact probability that Filipe wins the next match. Determine whether or not the two events \"Filipe wins\" and \"long practice time\" are independent. Justify your answer.",
      "topic": "Statistics & Probability",
      "correct": 0,
      "explanation": "P(Filipe wins | long) = 12/(15 + 12) = 12/27 = 4/9, while P(Filipe wins) = 22/45; since 4/9 ≠ 22/45 the events are NOT independent.",
    ...
    },
    {
      ...
      "part": "D",
      "type": "written",
      "text": "Griffin is riding his bike down the street in Churchville, N.Y. at a constant speed, when a nail gets caught in one of his tires. The height of the nail above the ground, in inches, can be represented by the trigonometric function f(t) = 13cos(0.8πt) + 13, where t represents the time (in seconds) since the nail first became caught in the tire. Determine the period of f(t) and interpret what the period represents in this context. On a grid, graph at least one cycle of f(t) that includes the y-intercept of the function. Does the height of the nail ever reach 30 inches above the ground? Justify your answer.",
      "topic": "Trigonometric Functions",
      "correct": 0,
      "explanation": "Period = 2π/(0.8π) = 2.5 seconds (one full tire rotation); since the maximum height is 13 + 13 = 26 inches, the nail never reaches 30 inches.",
