...
export default {
  ...
  questions: [
    ...
    { number: 32, part: 'B-1', text: 'Based on Table G, a solution that contains 90 grams of NaNO₃ dissolved in 100 grams of water at 40°C is best described as', choices: ['unsaturated', 'saturated', 'supersaturated', 'dilute'], topic: 'Solutions', correct: 2, explanation: 'At 40°C the maximum solubility of NaNO₃ is ~75 g/100 g H₂O; 90 g exceeds this maximum, making the solution supersaturated.', diveDeep: 'A supersaturated solution contains more dissolved solute than the saturation limit at that temperature — it is unstable and can crystallize rapidly when disturbed. It is prepared by dissolving extra solute at high temperature and carefully cooling. On Table G, a point plotted above the curve represents supersaturation. This concept is often paired with crystallization questions in Part B-2.' },
    ...
    { number: 46, part: 'B-1', text: 'Which functional group is characteristic of an ester, formed in an esterification reaction?', choices: ['-OH', '-COOH', '-COO-', '-CONH-'], topic: 'Organic Chemistry', correct: 2, explanation: 'The ester functional group is –COO– (or –COOR). Esters are formed from the reaction of a carboxylic acid and an alcohol.', diveDeep: 'Esterification: carboxylic acid + alcohol → ester + water. The ester linkage –COO– is characteristic of fats and many fruity/floral fragrances. Contrast with amide (–CONH–), which forms from a carboxylic acid and an amine. In saponification (soap-making), esters are hydrolyzed back to acid and alcohol under basic conditions. Knowing the ester linkage structure is tested both in functional group identification and reaction-type questions.' },
