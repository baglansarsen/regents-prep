...
export default {
  ...
  "questions": [
    ...
    },
    {
      ...
      "choices": [
        "as loosely packed in the nucleus of an atom",
    ...
    },
    {
      "number": 25,
      "part": "A",
      "text": "According to the Brønsted-Lowry theory, an acid is a substance that",
      "choices": [
        "accepts a proton",
        "donates a proton",
      ...
      "topic": "Acids & Bases",
      "correct": 1,
      "explanation": "A Brønsted-Lowry acid is defined as a proton (H⁺) donor — it gives a proton to the base in the reaction.",
      "diveDeep": "Brønsted-Lowry expands on Arrhenius: an acid donates H⁺ and a base accepts H⁺. This applies even in non-aqueous solutions. The Lewis definition is broader — Lewis acid accepts an electron pair, Lewis base donates one. The Regents tests all three definitions; know which is being asked. Conjugate acid-base pairs differ by one H⁺.",
      "subTopic": "Acids, Bases & pH"
    },
    {
      "number": 26,
      "part": "A",
      "text": "Which functional group is found in an amide?",
      "choices": [
        "-OH",
        "-COOH",
        "-CONH-",
      ...
      "topic": "Organic Chemistry",
      "correct": 2,
      "explanation": "The amide functional group is –CONH– (a carbonyl group bonded to a nitrogen).",
      "diveDeep": "Functional group identification: –OH is alcohol or carboxylic acid (if attached to C=O), –COOH is carboxylic acid, –CONH– is amide, –COO– is ester. Amides form when a carboxylic acid reacts with an amine (with loss of water), or in protein synthesis (peptide bonds). Distinguishing ester (–COO–) from amide (–CONH–) is a frequent trap on organic chemistry questions.",
      "subTopic": "Functional Groups"
    },
    {
      "number": 27,
      "part": "A",
      "text": "Which type of nuclear radiation has the greatest penetrating power?",
      "choices": [
        "alpha particles",
        "beta particles",
        "gamma rays",
    ...
    },
    {
      "number": 28,
      "part": "A",
      "text": "In terms of electrons, oxidation is best defined as",
      "choices": [
        "a gain of electrons",
        "a loss of electrons",
        "a gain of protons",
    ...
    },
    {
      "number": 29,
      "part": "A",
      "text": "In a voltaic cell, which electrode is the site of oxidation?",
      "choices": [
        "cathode",
        "anode",
        "salt bridge",
      ...
      "topic": "Redox & Electrochemistry",
      "correct": 1,
      "explanation": "In a voltaic cell, oxidation (loss of electrons) occurs at the anode — the negative electrode.",
    ...
    },
    {
      "number": 30,
      "part": "A",
      "text": "Which stress applied to an equilibrium system will cause the equilibrium to shift and produce more products?",
      "choices": [
        "adding a product",
        "removing a product",
      ...
      "topic": "Kinetics",
      "correct": 1,
      "explanation": "Removing a product decreases its concentration, and by Le Chatelier's principle the equilibrium shifts right (toward products) to restore balance.",
    ...
    },
    {
      "number": 31,
      "part": "B-1",
      "text": "Based on Table G, what is the maximum amount of NaNO₃ that can dissolve in 100 grams of water at 40°C?",
      "choices": [
        "about 55 g",
        "about 65 g",
        "about 75 g",
    ...
    },
    {
      "number": 32,
      "part": "B-1",
      "text": "Based on Table G, a solution that contains 90 grams of NaNO₃ dissolved in 100 grams of water at 40°C is best described as",
      "choices": [
        "unsaturated",
        "saturated",
        "supersaturated",
    ...
    },
    {
      "number": 33,
      "part": "B-1",
      "text": "Which statement correctly describes a potential energy diagram for an exothermic reaction?",
      "choices": [
        "The products have higher potential energy than the reactants.",
        "The products have lower potential energy than the reactants.",
        "The activation energy equals the heat of reaction.",
        "The activation energy is zero for an exothermic reaction."
      ],
      "topic": "Thermochemistry",
      "correct": 1,
      "explanation": "In an exothermic reaction, energy is released, so products have lower potential energy than reactants; ΔH is negative.",
    ...
    },
    {
      "number": 34,
      "part": "B-1",
      "text": "On a heating curve for water, which segment represents the substance entirely in the gas phase?",
      "choices": [
        "the segment where temperature rises from −20°C to 0°C",
        "the flat segment at 0°C",
        "the flat segment at 100°C",
        "the segment where temperature rises above 100°C"
      ],
      "topic": "Matter & Energy",
      "correct": 3,
      "explanation": "Once all liquid has vaporized at 100°C, additional heat raises the temperature of the gas. The segment above 100°C where temperature is increasing represents water entirely as steam.",
      "diveDeep": "A heating curve for water has 5 segments: (1) solid warming, (2) melting plateau at 0°C, (3) liquid warming, (4) boiling plateau at 100°C, (5) gas warming. Flat segments = phase changes (temperature constant, energy used to break/form intermolecular forces). Sloped segments = temperature rising within a single phase. Gas phase = segment 5 (rising above 100°C). The slope depends on the specific heat capacity of each phase.",
      "skill": "data",
      "subTopic": "Energy & Phase Changes"
    },
    {
      "number": 35,
      "part": "B-1",
      "text": "Based on Table S, what is the trend in first ionization energy as you move down Group 1 on the Periodic Table?",
      "choices": [
        "First ionization energy generally increases.",
        "First ionization energy generally decreases.",
        "First ionization energy remains the same.",
        "First ionization energy first increases, then decreases."
      ],
      "topic": "Periodic Table",
      "correct": 1,
      "explanation": "Going down Group 1, atoms have more electron shells, increasing atomic radius; the outermost electron is farther from the nucleus and easier to remove, so ionization energy decreases.",
      "diveDeep": "Table S lists first ionization energies. Down a group: more energy levels → larger atomic radius → valence electron farther from nucleus → less attraction → lower ionization energy. Across a period (left to right): nuclear charge increases → smaller radius → higher ionization energy. Noble gases have the highest ionization energies in each period. This trend is critical for understanding reactivity: low IE = metals readily lose electrons.",
      "skill": "reference",
    ...
    },
    {
      "number": 36,
      "part": "B-1",
      "text": "Based on Table N, what is the product of the alpha decay of thorium-232?",
      "choices": [
        "radium-228",
        "radon-228",
        "radium-224",
      ...
      "topic": "Nuclear Chemistry",
      "correct": 0,
      "explanation": "Alpha decay emits an alpha particle (⁴₂He), reducing mass number by 4 (232−4=228) and atomic number by 2 (90−2=88). Element 88 is radium, so the product is radium-228.",
      "diveDeep": "Alpha decay: ²³²₉₀Th → ²²⁸₈₈Ra + ⁴₂He. Mass number decreases by 4, atomic number decreases by 2. Element 88 is Ra (radium) from the Periodic Table. Table N lists common nuclear equations for reference. Beta decay: mass number unchanged, atomic number increases by 1. Gamma decay: neither mass nor atomic number changes. Always check the Periodic Table to identify the product element by its atomic number.",
      "skill": "reference",
      "subTopic": "Nuclear Chemistry"
    },
    {
      "number": 37,
      "part": "B-1",
      "text": "Strontium-90 has a half-life of approximately 29 years. After 58 years, what fraction of a strontium-90 sample remains?",
      "choices": [
        "1/2",
        "1/4",
        "1/8",
      ...
      "topic": "Nuclear Chemistry",
      "correct": 1,
      "explanation": "58 years = 2 half-lives (58 ÷ 29 = 2). After 2 half-lives: (1/2)² = 1/4 of the original sample remains.",
      "diveDeep": "Half-life formula: remaining fraction = (1/2)^n, where n = number of half-lives elapsed. n = total time ÷ half-life = 58 ÷ 29 = 2. (1/2)² = 1/4. A common mistake is using n = 58 instead of dividing by the half-life first. Half-life is constant regardless of sample size or conditions. After 3 half-lives: 1/8; after 4: 1/16. This calculation type appears on almost every Chemistry Regents exam.",
      "subTopic": "Nuclear Chemistry"
    },
    {
      "number": 38,
      "part": "B-1",
      "text": "What is the IUPAC name for the 4-carbon carboxylic acid?",
      "choices": [
        "butanoic acid",
        "butanol",
        "butenoic acid",
    ...
    },
    {
      "number": 40,
      "part": "B-1",
      "text": "In a neutralization titration, what is true at the equivalence point?",
      "choices": [
        "The moles of H⁺ equal the moles of OH⁻.",
        "The concentration of acid equals the concentration of base.",
        "The solution is always at pH 7.",
        "The volume of acid equals the volume of base."
      ],
      "topic": "Acids & Bases",
      "correct": 0,
      "explanation": "At the equivalence point in a neutralization reaction, the moles of H⁺ (from acid) exactly equal the moles of OH⁻ (from base), resulting in complete neutralization.",
      "diveDeep": "The equivalence point is defined by equal moles of H⁺ and OH⁻, not equal concentrations or volumes. The formula used is: M_a × V_a = M_b × V_b (when the acid and base are monoprotic). pH at equivalence is 7 only for strong acid + strong base titrations; with weak acids or bases, the pH will be above or below 7. This is one of the most quantitative concepts tested in Part B-2 and C.",
      "skill": "experiment",
      "subTopic": "Acids, Bases & pH"
    },
    {
      "number": 41,
      "part": "B-1",
      "text": "A container holds a mixture of nitrogen gas and oxygen gas. If the partial pressure of nitrogen is 600 mmHg and the partial pressure of oxygen is 200 mmHg, what is the total pressure of the gas mixture?",
      "choices": [
        "400 mmHg",
        "600 mmHg",
        "800 mmHg",
      ...
      "topic": "Gas Laws",
      "correct": 2,
      "explanation": "Dalton's Law of Partial Pressures: total pressure = sum of partial pressures. 600 + 200 = 800 mmHg.",
      "diveDeep": "Dalton's Law: P_total = P₁ + P₂ + P₃ + ... Each gas in a mixture behaves independently and contributes its partial pressure to the total. This applies to ideal gases. A common application: when collecting gas over water, the total pressure equals the gas pressure plus the vapor pressure of water (found on Table H). This concept is fundamental for stoichiometry problems involving gases collected over water.",
      "subTopic": "Gas Laws"
    },
    {
      "number": 42,
      "part": "B-1",
      "text": "Which expression correctly represents percent by mass of a solute in a solution?",
      "choices": [
    ...
    },
    {
      ...
      "topic": "Thermochemistry",
      "correct": 2,
      "explanation": "q = mCΔT = (50.0 g)(4.18 J/g·°C)(20.°C) = 4180 J of heat released as the water cools.",
      "diveDeep": "The formula q = mCΔT is on Table T. ΔT = T_final − T_initial = 60 − 80 = −20°C; the negative sign indicates heat is released (cooling). When asked for \"heat released,\" report the magnitude (positive value). C for water = 4.18 J/g·°C (given on Table B). Key trap: forgetting to multiply all three quantities or using incorrect ΔT sign. This type of calculation appears in nearly every Part B-2 and C section.",
      "subTopic": "Classification of Matter"
    },
    {
      "number": 44,
      "part": "B-1",
      "text": "In the reaction Zn(s) + 2HCl(aq) → ZnCl₂(aq) + H₂(g), which species is reduced?",
      "choices": [
        "Zn",
        "Cl⁻",
        "H⁺",
      ...
      "topic": "Redox & Electrochemistry",
      "correct": 2,
      "explanation": "H⁺ ions gain electrons (are reduced) to form H₂ gas; the oxidation state of H goes from +1 to 0.",
      "diveDeep": "Assign oxidation states: Zn goes from 0 to +2 (oxidized, loses 2e⁻). H goes from +1 (in HCl) to 0 (in H₂) (reduced, gains 2e⁻). Cl stays at −1 throughout (spectator ion). Zn is the reducing agent; H⁺ is the oxidizing agent. Single-replacement reactions always involve a metal displacing hydrogen or another metal, making them straightforward redox examples. This is a bread-and-butter Regents redox identification question.",
      "subTopic": "Redox & Electrochemistry"
    },
    {
      "number": 45,
      "part": "B-1",
      "text": "Based on Table I, what is the heat of combustion of methane (CH₄)?",
      "choices": [
        "−74.8 kJ/mol",
        "−285.8 kJ/mol",
        "−890.4 kJ/mol",
    ...
    },
    {
      "number": 46,
      "part": "B-1",
      "text": "Which functional group is characteristic of an ester, formed in an esterification reaction?",
      "choices": [
        "-OH",
        "-COOH",
        "-COO-",
      ...
      "topic": "Organic Chemistry",
      "correct": 2,
      "explanation": "The ester functional group is –COO– (or –COOR). Esters are formed from the reaction of a carboxylic acid and an alcohol.",
      "diveDeep": "Esterification: carboxylic acid + alcohol → ester + water. The ester linkage –COO– is characteristic of fats and many fruity/floral fragrances. Contrast with amide (–CONH–), which forms from a carboxylic acid and an amine. In saponification (soap-making), esters are hydrolyzed back to acid and alcohol under basic conditions. Knowing the ester linkage structure is tested both in functional group identification and reaction-type questions.",
      "subTopic": "Functional Groups"
    },
    {
      "number": 47,
      "part": "B-1",
      "text": "During electrolysis, toward which electrode do cations migrate?",
      "choices": [
      ...
      "topic": "Redox & Electrochemistry",
      "correct": 1,
      "explanation": "Cations (positive ions) are attracted to the cathode, which is the negative electrode in an electrolytic cell, where they are reduced.",
      "diveDeep": "Opposite charges attract: cations (positive) migrate to the cathode (negative); anions (negative) migrate to the anode (positive). At the cathode, cations gain electrons (reduction). At the anode, anions lose electrons (oxidation). In electrolysis of water, H⁺ (cations) are reduced to H₂ at the cathode; OH⁻ (anions) are oxidized to O₂ at the anode. This principle also applies in the electrolytic refining of metals (e.g., copper purification).",
      "subTopic": "Redox & Electrochemistry"
    },
    {
      "number": 48,
      "part": "B-1",
      "text": "Which statement correctly distinguishes a strong acid from a weak acid?",
      "choices": [
        "A strong acid partially dissociates in water; a weak acid fully dissociates.",
        "A strong acid fully dissociates in water; a weak acid partially dissociates.",
        "A strong acid has a higher Ka than 1; a weak acid has a Ka equal to 1.",
        "A strong acid has a higher pH than a weak acid at the same concentration."
      ],
      "topic": "Acids & Bases",
      "correct": 1,
      "explanation": "A strong acid (e.g., HCl, HNO₃) fully (completely) dissociates in water; a weak acid (e.g., CH₃COOH) only partially dissociates, establishing an equilibrium.",
      "diveDeep": "Strong acids: HCl, HBr, HI, HNO₃, H₂SO₄, HClO₄ — memorize these. All others are weak acids. Full dissociation means Ka is very large (not in equilibrium). Weak acid Ka is small (< 1), indicating mostly undissociated molecules at equilibrium. A strong acid of a given concentration has a lower pH (more H⁺) than a weak acid of the same concentration. This concept is tested with both conceptual and calculation questions.",
      "subTopic": "Acids, Bases & pH"
    },
    {
      "number": 49,
      "part": "B-1",
      "text": "Which change increases the entropy of a system?",
      "choices": [
    ...
    },
    {
      ...
      "topic": "Matter & Energy",
      "correct": 1,
      "explanation": "In multiplication (and division), the result must have the same number of significant figures as the measurement with the fewest significant figures. 2.5 has 2 sig figs; 3.42 has 3 sig figs → the answer must have 2 significant figures.",
      "diveDeep": "Significant figure rules for multiplication/division: count sig figs in each factor and use the smallest count for the answer. 2.5 × 3.42 = 8.55 cm² → rounded to 2 sig figs = 8.6 cm². For addition/subtraction, the rule is different: use the fewest decimal places. Common traps: zeros as placeholders are not significant (0.0025 has 2 sig figs); trailing zeros after a decimal point are significant (3.40 has 3 sig figs). Significant figures appear in calculation questions throughout the exam.",
      "subTopic": "Classification of Matter"
    }
  ]
}
