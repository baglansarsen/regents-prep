  ...
  "questions": [
    {
      "number": 1,
      "part": "A",
      "text": "Bryan’s hockey team is purchasing jerseys. The company charges $250 for a one-time set-up fee and $23 for each printed jersey. Which expression represents the total cost of x number of jerseys for the team?",
      "choices": [
        "23x",
        "23x + 250",
        "23 + 250x",
    ...
    },
    {
      "number": 2,
      "part": "A",
      "text": "Which table represents a function?",
      "choices": [
        "",
        "",
        "",
    ...
    },
    {
      "number": 3,
      "part": "A",
      "text": "Which expression is equivalent to 2(x² + 1) + 3x(x + 4)?",
      "choices": [
        "5x² + 5",
        "5x² + 12x + 1",
        "5x² + 6",
    ...
    },
    {
      "number": 4,
      "part": "A",
      "text": "The value of x that satisfies the equation ¾(x + 4/3) = 10/15 is",
      "choices": [
        "6",
        "10",
        "−5",
    ...
    },
    {
      "number": 5,
      "part": "A",
      "text": "Josh graphed the function f(x) = 3(x − 1)² + 2. He then graphed the function g(x) = 3(x − 1)² − 5 on the same coordinate plane. The vertex of g(x) is",
      "choices": [
        "7 units below the vertex of f(x)",
        "7 units above the vertex of f(x)",
        "7 units to the right of the vertex of f(x)",
        "7 units to the left of the vertex of f(x)"
      ],
    ...
    },
    {
      "number": 6,
      "part": "A",
      "text": "A survey was given to 12th-grade students of West High School to determine the location for the senior class trip. The results are shown in the table. Niagara Falls / Darien Lake / New York City — Boys: 56, 74, 103; Girls: 71, 92, 88. To the nearest percent, what percent of the boys chose Niagara Falls?",
      "choices": [
        "12",
        "24",
        "44",
    ...
    },
    {
      "number": 7,
      "part": "A",
      "text": "Which type of function is shown in the graph of population size N versus time t?",
      "choices": [
        "linear",
        "square root",
        "exponential",
      ...
      "topic": "Functions & Relations",
      "correct": 2,
      "image": "/images/exams/alg1-august-2019/q7.png",
    ...
    },
    {
      "number": 8,
      "part": "A",
      "text": "The expression 16x² − 81 is equivalent to",
      "choices": [
        "(8x + 9)(8x − 9)",
        "(4x + 9)(4x − 9)",
        "(8x − 9)(8x − 9)",
    ...
    },
    {
      "number": 9,
      "part": "A",
      "text": "The owner of a landscaping business wants to know how much time, on average, his workers spend mowing one lawn. Which is the most appropriate rate with which to calculate an answer to his question?",
      "choices": [
        "lawns per employee",
        "employee per lawns",
        "lawns per day",
    ...
    },
    {
      "number": 10,
      "part": "A",
      "text": "A ball is thrown into the air from the top of a building. The height, h(t), of the ball above the ground t seconds after it is thrown can be modeled by h(t) = −16t² + 64t + 80. How many seconds after being thrown will the ball hit the ground?",
      "choices": [
        "5",
        "80",
        "2",
    ...
    },
    {
      "number": 11,
      "part": "A",
      "text": "Which equation is equivalent to y = x² − 24x + 18?",
      "choices": [
        "y = (x − 12)² − 126",
        "y = (x − 12)² + 126",
        "y = (x + 12)² − 126",
    ...
    },
    {
      "number": 12,
      "part": "A",
      "text": "When (x)(x + 5)(2x − 3) is expressed as a polynomial in standard form, which statement about the resulting polynomial is true?",
      "choices": [
    ...
    },
    {
      "number": 13,
      "part": "A",
      "text": "The population of a city can be modeled by P(t) = 3810(1.0005)⁷ᵗ, where P(t) is the population after t years. Which function is approximately equivalent to P(t)?",
      "choices": [
        "P(t) = 3810(0.1427)ᵗ",
        "P(t) = 26,670(0.1427)ᵗ",
        "P(t) = 3810(1.0035)ᵗ",
    ...
    },
    {
      "number": 14,
      "part": "A",
      "text": "The functions f(x) and g(x) are graphed on the set of axes below. For which value of x is f(x) = g(x)?",
      "choices": [
        "1",
        "−1",
        "−2",
      ...
      "topic": "Functions & Relations",
      "correct": 2,
      "image": "/images/exams/alg1-august-2019/q14.png",
    ...
    },
    {
      "number": 15,
      "part": "A",
      "text": "What is the range of the box plot shown below?",
      "choices": [
        "7",
        "3",
        "2",
      ...
      "topic": "Statistics & Probability",
      "correct": 0,
      "image": "/images/exams/alg1-august-2019/q15.png",
    ...
    },
    {
      "number": 16,
      "part": "A",
      "text": "Which expression is not equivalent to 2x² − 10x − 12?",
      "choices": [
        "(2x + 4)(x − 3)",
        "(2x − 3)(x + 4)",
        "(2x − 6)(x + 2)",
    ...
    {
      "number": 17,
      "image": "/images/exams/alg1-august-2019/q17.png",
      "part": "A",
      "text": "The quadratic functions r(x) and q(x) are given. r(x) is shown in a table with minimum value −16, and q(x) = x² + 2x − 8. The function with the smallest minimum value is",
      "choices": [
        "q(x), and the value is −9",
        "r(x), and the value is −16",
        "q(x), and the value is 1",
        "r(x), and the value is −2"
      ],
      "topic": "Quadratic Functions",
      "correct": 1,
    ...
    },
    {
      "number": 18,
      "part": "A",
      "text": "A child is playing outside. The graph shows the child’s distance, d(t), in yards from home over a period of time, t, in seconds. Which interval represents the child constantly moving closer to home?",
      "choices": [
        "0 < t < 2",
        "3 < t < 4",
        "2 < t < 3",
      ...
      "topic": "Functions & Relations",
      "correct": 0,
      "image": "/images/exams/alg1-august-2019/q18.png",
    ...
    },
    {
      "number": 19,
      "part": "A",
      "text": "If a₁ = 6 and aₙ = 3 + 2(aₙ₋₁)², then a₂ equals",
      "choices": [
        "75",
        "180",
        "147",
    ...
    },
    {
      "number": 20,
      "part": "A",
      "text": "The length of a rectangular patio is 7 feet more than its width, w. The area of a patio, A(w), can be represented by the function",
      "choices": [
        "A(w) = w + 7",
        "A(w) = 4w + 14",
        "A(w) = w² + 7w",
    ...
    },
    {
      "number": 21,
      "part": "A",
      "text": "A dolphin jumps out of the water and then back into the water. His jump could be graphed on a set of axes where x represents time and y represents distance above or below sea level. The domain for this graph is best represented using a set of",
      "choices": [
        "integers",
        "real numbers",
        "positive integers",
    ...
    },
    {
      "number": 22,
      "part": "A",
      "text": "Which system of linear equations has the same solution as the one shown below? x + 4y = 10 ; x − y = 5",
      "choices": [
        "5x = 30 ; x − y = 5",
        "5y = 5 ; x − y = 5",
        "5y = 5 ; x + 4y = 10",
    ...
    },
    {
      "number": 23,
      "part": "A",
      "text": "Which interval represents the range of the function h(x) = 2x² + 2x − 4?",
      "choices": [
        "(0.5, ∞)",
        "[0.5, ∞)",
        "(−4.5, ∞)",
    ...
    },
    {
      "number": 24,
      "part": "A",
      "text": "What is a common ratio of the geometric sequence whose first term is 5 and third term is 245?",
      "choices": [
        "7",
        "120",
        "49",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "If g(x) = −4x² + 3x − 2, determine g(−2).",
      "topic": "Functions & Relations",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "A student is in the process of solving an equation. The original equation and the first step are shown below. Original: 3a + 6 = 2 − 5a + 7. Step one: 3a + 6 = 2 + 7 − 5a. Which property did the student use for the first step? Explain why this property is correct.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "The student rearranged −5a + 7 into 7 − 5a, which uses the commutative property of addition.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "On the set of axes provided, graph the line whose equation is 2y = −3x + 2. This linear equation contains the point (2, k). State the value of k.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "Dividing by 2 gives y = −(3/2)x + 1; substituting x = 2 gives k = −2.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "The formula a = (v_f − v_i)/t is used to calculate acceleration as the change in velocity over the period of time. Solve the formula for the final velocity, v_f, in terms of initial velocity, v_i, acceleration, a, and time, t.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "Multiplying both sides by t and adding v_i isolates v_f, giving v_f = at + v_i.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Solve (x + 3)/5 + (x + 4)/5 = 3 for x.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "Combining the fractions gives (2x + 7)/5 = 3, so 2x + 7 = 15 and x = 4.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Is the product of two irrational numbers always irrational? Justify your answer.",
      "topic": "Polynomials & Factoring",
      "explanation": "No — for example, √2 · √2 = 2, which is rational, so a single counterexample disproves the claim.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Solve 6x² − 42 = 0 for the exact values of x.",
      "topic": "Quadratic Functions",
      "explanation": "Isolating x² gives x² = 7, so x = ±√7.",
    ...
    },
    {
      ...
      "part": "B",
      "type": "written",
      "text": "Graph the piecewise function h(x) = { x − 3 for x ≤ 0 ; x + 5 for x > 0 } on the set of axes provided.",
      "topic": "Functions & Relations",
      "explanation": "Graph the line y = x − 3 for inputs at or below 0 (closed point at (0, −3)) and the line y = x + 5 for inputs above 0 (open point at (0, 5)).",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "On the set of axes provided, graph the following system of inequalities: 2x + y > 8 ; y ≤ 5 − 3x. Determine if the point (1, 8) is in the solution set. Explain your answer.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "Testing (1, 8): 2(1) + 8 = 10 > 8 is true, but 8 ≤ 5 − 3(1) = 2 is false, so (1, 8) is NOT in the solution set.",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "On the day Alexander was born, his father invested $5000 in an account with a 1.2% annual growth rate. Write a function, A(t), that represents the value of this investment t years after Alexander’s birth. Determine, to the nearest dollar, how much more the investment will be worth when Alexander turns 32 than when he turns 17.",
      "topic": "Functions & Relations",
      "explanation": "A(t) = 5000(1.012)^t; A(32) − A(17) ≈ 7330 − 6122 = $1208 more.",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "Stephen collected data on a hotel’s distance from Times Square (x, in city blocks) and the cost of a room for one weekend night (y, in dollars). Distance: 0, 0, 1, 1, 3, 4, 7, 11, 14, 19. Cost: 293, 263, 244, 224, 185, 170, 219, 153, 136, 111. Write the linear regression equation for this data set, rounding all values to the nearest hundredth. State the correlation coefficient to the nearest hundredth, and explain what its sign suggests in the context of the problem.",
      "topic": "Statistics & Probability",
      "explanation": "The regression equation is approximately y = −7.76x + 246.34 with r ≈ −0.86; the negative sign means room cost tends to decrease as distance from Times Square increases.",
    ...
    },
    {
      ...
      "part": "C",
      "type": "written",
      "text": "A snowstorm started at midnight. For the first 4 hours, it snowed at an average rate of one-half inch per hour. The snow then fell at an average rate of one inch per hour for the next 6 hours. Then it stopped snowing for 3 hours. Then it started snowing again at one-half inch per hour for the next 4 hours until the storm was over. On the set of axes provided, graph the amount of snow accumulated over the time interval of the storm. Determine the average rate of snowfall over the length of the storm, to the nearest hundredth of an inch per hour.",
      "topic": "Linear Equations & Inequalities",
      "explanation": "Total snow = 2 + 6 + 0 + 2 = 10 inches over 17 hours, so the average rate is 10/17 ≈ 0.59 inch per hour.",
