...
export default {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['(6x − 3)²', '(6x + 3)(6x − 3)', '(18x − 4.5)²', '(18x + 4.5)(18x − 4.5)'],
    ...
    },
    {
      ...
      choices: ['18x² − 9x − 27', '18x³ − 9x² − 27x', '18x² − 3x + 3', '18x³ − 9x² + 9x'],
      topic: 'Polynomials & Factoring',
      correct: 1,
    ...
    },
    {
      ...
      choices: ['600(1 + 0.24)⁴', '600(1 − 0.024)⁴', '600(1 + 0.024)⁴', '600(0.024)⁴'],
      topic: 'Functions & Relations',
      correct: 2,
    ...
    },
    {
      ...
      choices: ['f(x), g(x), h(x)', 'h(x), f(x), g(x)', 'g(x), h(x), f(x)', 'f(x), h(x), g(x)'],
      topic: 'Quadratic Functions',
      correct: 3,
    ...
    },
    {
      ...
      choices: ['The value of a car depreciates by 7% annually.', 'A gym charges a $50 initial fee and then $30 monthly.', 'The number of bacteria in a lab doubles weekly.', 'The amount of money in a bank account increases by 0.1% monthly.'],
      topic: 'Linear Equations & Inequalities',
      correct: 1,
    ...
    },
    {
      ...
      choices: ['(x + 5)² = 38', '(x + 10)² = 38', '(x + 5)² = 12', '(x + 10)² = 12'],
      topic: 'Quadratic Functions',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['C(d) = 240·3ᵈ', 'C(d) = 120·6ᵈ', 'C(d) = 960·2ᵈ', 'C(d) = 120·8ᵈ'],
      topic: 'Functions & Relations',
      correct: 3,
    ...
    },
    {
      ...
      choices: ['A and C', 'D and C', 'A and B', 'D and B'],
      topic: 'Number Theory',
      correct: 3,
    ...
    },
    {
      ...
      choices: ['b = (2V − ah·c) / (ah)', 'b = (2V) / (ah) − c', 'b = (2V − c) / (ah)', 'b = 2V/(ah) + c'],
      topic: 'Linear Equations & Inequalities',
      correct: 1,
    ...
    {
      number: 26, image: '/images/exams/alg1-august-2022/q26.png',
      part: 'B',
      type: 'written',
