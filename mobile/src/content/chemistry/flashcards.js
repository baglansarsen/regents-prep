...
export const flashcards = [
  ...
  // Matter & Energy
  { topic: TOPICS.MATTER_AND_ENERGY, term: 'Temperature', definition: 'A measure of the average kinetic energy of the particles in a sample of matter.' },
  { topic: TOPICS.MATTER_AND_ENERGY, term: 'Ideal Gas', definition: 'A theoretical gas whose molecules have no volume and exert no attractive forces on each other.' },
  { topic: TOPICS.MATTER_AND_ENERGY, term: 'Endothermic', definition: 'A process that absorbs heat energy from its surroundings, resulting in a positive change in enthalpy (+ΔH).' },
  { topic: TOPICS.MATTER_AND_ENERGY, term: 'Exothermic', definition: 'A process that releases heat energy into its surroundings, resulting in a negative change in enthalpy (-ΔH).' },
