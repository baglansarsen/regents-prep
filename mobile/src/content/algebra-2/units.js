...
const SUBTOPIC_UNITS = [TOPICS.POLY_OPS, TOPICS.POLY_GRAPHS]
const PSM_SKILLS = ['modeling', 'reasoning']

export const UNITS = [
  // ── Polynomial Functions, split ──
  { id: 'algebra-2-pops',  title: 'Polynomial Operations & Factoring', icon: TOPIC_ICONS[TOPICS.POLY_OPS],             color: '#06b6d4', darkColor: '#0891b2', topic: TOPICS.POLY_OPS,             lessonCount: 3 },
  { id: 'algebra-2-pgr',   title: 'Polynomial Graphs, Zeros & Conics', icon: TOPIC_ICONS[TOPICS.POLY_GRAPHS],          color: '#0ea5e9', darkColor: '#0284c7', topic: TOPICS.POLY_GRAPHS,          lessonCount: 2 },
  { id: 'algebra-2-u2',    title: 'Rational & Radical Expressions',    icon: TOPIC_ICONS[TOPICS.RATIONAL_RADICAL],     color: '#38bdf8', darkColor: '#0ea5e9', topic: TOPICS.RATIONAL_RADICAL,     lessonCount: 2 },
  { id: 'algebra-2-u3',    title: 'Exponential & Logarithmic',         icon: TOPIC_ICONS[TOPICS.EXPONENTIAL_LOG],      color: '#22d3ee', darkColor: '#06b6d4', topic: TOPICS.EXPONENTIAL_LOG,      lessonCount: 3 },
  { id: 'algebra-2-u4',    title: 'Trigonometric Functions',           icon: TOPIC_ICONS[TOPICS.TRIGONOMETRY],         color: '#0891b2', darkColor: '#0e7490', topic: TOPICS.TRIGONOMETRY,         lessonCount: 2 },
  // Problem-Solving & Modeling: cross-topic word-problem + reasoning practice.
  { id: 'algebra-2-psm',   title: 'Problem-Solving & Modeling',        icon: TOPIC_ICONS[TOPICS.PROBLEM_SOLVING],      color: '#2563eb', darkColor: '#1d4ed8', topic: TOPICS.PROBLEM_SOLVING,      lessonCount: 3, skillPool: PSM_SKILLS },
  { id: 'algebra-2-u5',    title: 'Statistics & Probability',          icon: TOPIC_ICONS[TOPICS.STATISTICS],           color: '#67e8f9', darkColor: '#22d3ee', topic: TOPICS.STATISTICS,           lessonCount: 2 },
  { id: 'algebra-2-u6',    title: 'Complex Numbers',                   icon: TOPIC_ICONS[TOPICS.COMPLEX_NUMBERS],      color: '#a5f3fc', darkColor: '#67e8f9', topic: TOPICS.COMPLEX_NUMBERS,      lessonCount: 1 },
  { id: 'algebra-2-u7',    title: 'Sequences & Series',                icon: TOPIC_ICONS[TOPICS.SEQUENCES],            color: '#10b981', darkColor: '#059669', topic: TOPICS.SEQUENCES,            lessonCount: 1 },
  { id: 'algebra-2-u8',    title: 'Systems & Inequalities',            icon: TOPIC_ICONS[TOPICS.SYSTEMS_INEQUALITIES], color: '#14b8a6', darkColor: '#0f766e', topic: TOPICS.SYSTEMS_INEQUALITIES, lessonCount: 1 },
]
