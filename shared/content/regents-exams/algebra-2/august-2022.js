...
export default {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['16(x² − 2)(x² + 2)', '16(x² + 2)²', '(4x² − 8)(4x² + 8)', '16(x − 2)(x + 2)(x² + 2)'],
    ...
    },
    {
      ...
      choices: ['experimental', 'a sample survey', 'observational', 'a random assignment'],
    ...
    },
    {
      ...
      choices: ['f(x) = (x + 3)(x − 1)(x + 2)', 'f(x) = (x − 3)(x + 1)(x − 2)', 'f(x) = (x − 3)(x − 1)(x − 2)', 'f(x) = (x + 3)(x + 1)(x + 2)'],
      topic: 'Polynomial Functions',
      correct: 1,
    ...
    },
    {
      ...
      choices: ['2 log a + 3 log b', '6 log(ab)', 'log a² + log b³ as a product', '2 log a · 3 log b'],
    ...
    },
    {
      ...
      choices: ['6ab − 8b√(ab)', '6ab', '−2√(ab)', '6√(a)b − 8b√(ab)'],
      topic: 'Rational & Radical',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['(1 − x)/(x + 2)', '(3x)/(5x + 6)', 'x/(x + 2)', '1 + 1/(2x + 6)'],
      topic: 'Rational & Radical',
      correct: 2,
