  ...
  questions: [
    {
      ...
      choices: ['2x² − 9x + 9', '2x² − x − 5', '4x² − 9x − 5', '2x² − 9x − 5'],
    ...
    },
    {
      ...
      choices: ['3, −2, 5', '−3, 2, −5', '3, 2, 5', '−3, −2, −5'],
      topic: 'Polynomial Functions',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['y = 200(0.85)ˣ', 'y = 200(1.15)ˣ', 'y = 200(0.15)ˣ', 'y = 200(1.85)ˣ'],
      topic: 'Exponential & Logarithmic',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['y = 27sin((2π/3)x) − 5', 'y = 27sin(3x) − 5', 'y = 27sin((3π/2)x) + 9', 'y = 3sin(πx) + 9'],
      topic: 'Trigonometric Functions',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['15 + 13xi', '15 + 7xi', '−15 + 13xi', '−15 + 9xi'],
      topic: 'Complex Numbers',
      correct: 3,
    ...
    },
    {
      ...
      choices: ['V(x) = 4x² − 72x + 324', 'V(x) = 4x³ − 72x² + 324x', 'V(x) = 23x + 36', 'V(x) = 4x³ + 324x'],
      topic: 'Functions',
      correct: 1,
    ...
    },
    {
      ...
      choices: ['sec θ > 0 and tan θ > 0', 'sec θ < 0 and tan θ < 0', 'sec θ > 0 and tan θ < 0', 'sec θ < 0 and tan θ > 0'],
      topic: 'Trigonometric Functions',
      correct: 3,
    ...
    },
    {
      ...
      choices: ['Yes, because P(N)·P(W) = P(N ∩ W).', 'Yes, because P(N)·P(W) ≠ P(N ∩ W).', 'No, because P(N)·P(W) = P(N ∩ W).', 'No, because P(N)·P(W) ≠ P(N ∩ W).'],
      topic: 'Statistics & Probability',
      correct: 0,
    ...
    },
    {
      ...
      choices: ['(x − y)⁸', '(x⁴ + y⁴)(x² + y²)(x + y)(x − y)', '(x² + y²)²(x² − y²)²', '(x + y)⁴(x − y)⁴'],
      topic: 'Polynomial Functions',
      correct: 1,
    ...
    },
    {
      ...
      choices: ['$91,837', '$877,917', '$109,709', '$985,475'],
      topic: 'Sequences & Series',
      correct: 3,
