...
export default {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['sin M = cos T', 'sin T = cos R', 'sin R = cos R', 'sin T = cos M'],
      topic: 'Trigonometry',
      correct: 1,
