...
export default {
  ...
  questions: [
      ...
      diveDeep: 'A point reflection through the origin maps (x,y) to (−x,−y) and is identical to a 180° rotation about the origin. Test a single vertex with each rule to eliminate options: reflection over y = x gives (y,x), reflection over y = −x gives (−y,−x), and a translation shifts every point by the same vector. Reading exact coordinates from the graph and applying each rule algebraically is far more reliable than eyeballing the flip, especially when several transformations look similar on the figure.', image: '/images/exams/geo-august-2025/q9.png' },
    {
      ...
      diveDeep: 'The two-secant rule states (whole external secant)×(its external part) is equal for both secants: PA·PC = PB·PD, where the products use the FULL secant length times the EXTERNAL near-segment. The most common error is mixing up whole-secant versus external-segment lengths, or forgetting to add DB to PD to get the whole second secant PB. Carefully label which lengths are "whole" (from P to the far intersection) and which are "external" (from P to the near intersection) before substituting.', image: '/images/exams/geo-august-2025/q10.png' },
    {
      number: 11,
      part: 'A',
      ...
      diveDeep: 'This is a two-step volume-then-density problem. First compute pyramid volume with V = (1/3)Bh where B is the area of the square base (side², not side). Then apply density: mass = density × volume. The most common error is omitting the 1/3 factor (which would give the prism volume and lead to ~901 g, a distractor), or squaring the wrong quantity. Keep full precision through the volume step and round only the final mass.', image: '/images/exams/geo-august-2025/q13.png' },
    {
      ...
      diveDeep: 'The Midsegment (Midline) Theorem says a segment joining midpoints of two sides is parallel to the third side and exactly half its length: DE = ½·AC. Set up 2·DE = AC, i.e. 2(x+3) = 3x−5, solve for x, then substitute back into the DE expression — never stop at x. The classic trap is reporting x itself, or forgetting the factor of ½ and setting the two expressions equal directly. Always substitute the solved variable back into the requested quantity.', image: '/images/exams/geo-august-2025/q14.png' },
    {
      number: 15,
      part: 'A',
      ...
      diveDeep: 'A 45-45-90 triangle has the fixed side ratio leg : leg : hypotenuse = 1 : 1 : √2. With the right angle at G, the hypotenuse is the opposite side DU, and the two legs GU and GD are equal. Divide the hypotenuse by √2 to get a leg, then simplify √10/√2 = √5. A common mistake is treating DU as a leg, or mishandling the radical division; rationalizing (√10·√2)/2 = √20/2 = √5 confirms the result.', image: '/images/exams/geo-august-2025/q15.png' },
    {
      number: 16,
      part: 'A',
    ...
    },
    {
      ...
      diveDeep: 'On a coordinate grid, vertical and horizontal segments can be counted directly from coordinate differences, while diagonal segments need the distance formula √((x₂−x₁)² + (y₂−y₁)²). Simplify the radical: √80 = √(16·5) = 4√5. The trap "5√16" simplifies to 5·4 = 20, an incorrect, unsimplified-looking distractor. Always reduce radicals fully and add the leg lengths separately from the hypotenuse term.', image: '/images/exams/geo-august-2025/q18.png' },
    {
      number: 19,
      part: 'A',
    ...
    },
    {
      ...
      modelAnswer: 'The volume of the cube is V = (5 cm)³ = 125 cm³. Density = mass ÷ volume = 982.5 g ÷ 125 cm³ = 7.86 g/cm³. From the table, a density of 7.86 g/cm³ corresponds to Iron. Therefore the cube is made of Iron.', image: '/images/exams/geo-august-2025/q26.png' },
    {
      number: 27,
      part: 'B',
      ...
      modelAnswer: 'A divides CS so that CA:AS = 3:2, meaning A is 3/(3+2) = 3/5 of the way from C to S. Δx = 7 − (−3) = 10 and Δy = 6 − 1 = 5. x_A = −3 + (3/5)(10) = −3 + 6 = 3. y_A = 1 + (3/5)(5) = 1 + 3 = 4. Therefore A = (3, 4).', image: '/images/exams/geo-august-2025/q27.png' },
    {
      number: 28,
      part: 'B',
      ...
      modelAnswer: 'The 0.6 m vertical height is opposite the 4.8° angle of elevation, and the ramp is the hypotenuse. sin(4.8°) = 0.6 / ramp. ramp = 0.6 / sin(4.8°) ≈ 0.6 / 0.08368 ≈ 7.17 m. To the nearest tenth, the length of the ramp is 7.2 m.', image: '/images/exams/geo-august-2025/q28.png' },
    {
      number: 29,
      part: 'B',
      ...
      modelAnswer: 'Because ∠KML is the vertex angle, the base angles are congruent: m∠K = m∠MLK = 15°. ∠KMN is an exterior angle of △KLM at vertex M, so by the Exterior Angle Theorem m∠KMN = m∠K + m∠MLK = 15° + 15° = 30°. Therefore m∠KMN = 30°.', image: '/images/exams/geo-august-2025/q29.png' },
    {
      number: 30,
      part: 'B',
      ...
      modelAnswer: 'The area of a sector is (θ/360)·πr². Substituting area = 7.5π and r = 5: 7.5π = (θ/360)·π(5²) = (θ/360)·25π. Dividing both sides by π: 7.5 = (θ/360)·25. So θ/360 = 7.5/25 = 0.3, and θ = 0.3 × 360 = 108°. Therefore m∠KLM = 108°.', image: '/images/exams/geo-august-2025/q30.png' },
    {
      number: 31,
      part: 'B',
      ...
      modelAnswer: 'Let d be the horizontal distance from the tree to the shorter cable\'s anchor. tan(50°) = 12/d, so d = 12/tan(50°) ≈ 10.07 ft. The longer cable is anchored 3 ft farther: 10.07 + 3 ≈ 13.07 ft, which rounds to 13 feet. For the angle of elevation θ of the longer cable: tan(θ) = 12/13.07, so θ = tan⁻¹(12/13.07) ≈ 42.6°, which rounds to 43°. Therefore the longer cable is anchored about 13 feet from the tree, and its angle of elevation is about 43°.', image: '/images/exams/geo-august-2025/q33.png' },
    {
      ...
      modelAnswer: 'Compute the four side slopes. slope RE = (7−3)/(2−(−1)) = 4/3. slope EA = (1−7)/(10−2) = −6/8 = −3/4. slope AD = (−3−1)/(7−10) = −4/−3 = 4/3. slope DR = (3−(−3))/(−1−7) = 6/−8 = −3/4. Opposite sides have equal slopes: slope RE = slope AD = 4/3 and slope EA = slope DR = −3/4, so RE ∥ AD and EA ∥ DR; therefore READ is a parallelogram. Adjacent sides RE and EA have slopes 4/3 and −3/4, which are negative reciprocals (their product is −1), so RE ⊥ EA and ∠E is a right angle. A parallelogram with a right angle is a rectangle. Therefore READ is a rectangle.', image: '/images/exams/geo-august-2025/q34.png' },
    {
      number: 35,
      part: 'D',
