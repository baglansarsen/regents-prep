...
export default {
  ...
  questions: [
    ...
    },
    {
      ...
      diveDeep: 'Two mechanisms generate genetic variation during meiosis: (1) Crossing-over (recombination) — during prophase I, homologous chromosomes exchange segments, creating new allele combinations on each chromosome. (2) Independent assortment — during metaphase I, homologous pairs align randomly, so each gamete gets a random mix of maternal and paternal chromosomes (2²³ ≈ 8 million possibilities in humans). Additionally, fertilization adds another layer of randomness — which sperm fertilizes which egg. Asexual reproduction (in choice A) produces genetically identical offspring, so it reduces variation; only mutations would create variation in asexually reproducing populations. Mitosis (choice B) also produces identical cells. Cloning (choice D) is artificial asexual reproduction, producing genetically identical individuals. Sexual reproduction + meiosis = key sources of genetic variation.', image: '/images/exams/le-june-2023/q10.png' },
    {
      number: 11, part: 'A',
