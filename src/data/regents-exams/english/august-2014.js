  ...
  "questions": [
    {
      "number": 1,
      "part": "I",
      "text": "The sentence, “But it was still there ... an empty echo” (lines 13 through 15) contributes to a central theme by",
      "choices": [
        "connecting the people’s inner feelings and outer lives",
        "suggesting a reason for the longtang’s crumbling structure",
    ...
    },
    {
      "number": 2,
      "part": "I",
      "text": "The author’s use of figurative language in lines 18 and 19 serves to emphasize a sense of",
      "choices": [
        "community spirit",
        "societal unrest",
        "emotional burden",
    ...
    },
    {
      "number": 3,
      "part": "I",
      "text": "As used in line 19, the phrase “immaterial things” means that the things are",
      "choices": [
        "unimportant",
        "unforeseen",
        "frightening",
    ...
    },
    {
      "number": 4,
      "part": "I",
      "text": "According to lines 31 through 39, a person living in the longtang would most probably pray for",
      "choices": [
        "protection from neighborhood conflict",
        "a quiet and uneventful life",
    ...
    },
    {
      "number": 5,
      "part": "I",
      "text": "Lines 40 through 53 suggest that the longtang people",
      "choices": [
        "make the best of their situation",
        "survive difficult challenges",
    ...
    },
    {
      "number": 6,
      "part": "I",
      "text": "The comparison in lines 73 through 78 emphasizes the longtang’s",
      "choices": [
        "former vitality",
        "enduring strength",
        "past importance",
    ...
    },
    {
      "number": 7,
      "part": "I",
      "text": "The reference to the seasons in the final paragraph conveys a sense of",
      "choices": [
        "anticipation",
        "loss",
        "hope",
    ...
    },
    {
      "number": 8,
      "part": "I",
      "text": "The author’s description of the people’s prayers and the longtang stresses the",
      "choices": [
        "futility of the people’s situation",
        "security of the people’s future",
    ...
    },
    {
      "number": 9,
      "part": "I",
      "text": "Overall, the author’s view of the people of the longtang could best be described as",
      "choices": [
        "intolerant",
        "objective",
        "sympathetic",
    ...
    },
    {
      "number": 10,
      "part": "I",
      "text": "The details presented in lines 4 through 13 emphasize the landscape’s",
      "choices": [
    ...
    },
    {
      "number": 11,
      "part": "I",
      "text": "What shift in focus occurs from lines 7 through 27?",
      "choices": [
    ...
    },
    {
      "number": 12,
      "part": "I",
      "text": "What is the effect of the simile used in lines 21 and 22?",
      "choices": [
    ...
    },
    {
      "number": 13,
      "part": "I",
      "text": "Which word best describes the narrator’s tone in lines 28 through 38 of the poem?",
      "choices": [
        "frustrated",
        "embarrassed",
        "contentment",
    ...
    },
    {
      "number": 14,
      "part": "I",
      "text": "Lines 33 through 37 contribute to a central theme in the poem by describing the narrator’s",
      "choices": [
    ...
    },
    {
      "number": 15,
      "part": "I",
      "text": "The speaker’s use of symbolism in lines 10 and 11 serves to represent the",
      "choices": [
    ...
    },
    {
      "number": 16,
      "part": "I",
      "text": "The details in lines 16 and 17 contribute to the speaker’s purpose by",
      "choices": [
        "presenting a resolution to the conflict",
        "indicating the reason for the meeting",
    ...
    },
    {
      "number": 17,
      "part": "I",
      "text": "Lines 22 through 24 establish a",
      "choices": [
    ...
    },
    {
      "number": 18,
      "part": "I",
      "text": "In the speech, the Six Nations’ uncertainty regarding the status of the Canandaigua Treaty in lines 30 and 31 is based on the",
      "choices": [
    ...
    },
    {
      "number": 19,
      "part": "I",
      "text": "Which statement best clarifies the sentence in lines 8 through 10?",
      "choices": [
    ...
    },
    {
      "number": 20,
      "part": "I",
      "text": "The speaker’s attitude in lines 37 through 42 can best be described as",
      "choices": [
        "uncertain",
        "compassionate",
        "sarcastic",
    ...
    },
    {
      "number": 21,
      "part": "I",
      "text": "The speaker’s request in lines 48 through 51 serves to emphasize the Six Nations’",
      "choices": [
    ...
    },
    {
      "number": 22,
      "part": "I",
      "text": "Which words from the speech help the reader understand the meaning of “redress” as used in line 54?",
      "choices": [
        "“judge it proper” (line 50)",
        "“They have made application” (line 53)",
    ...
    },
    {
      "number": 23,
      "part": "I",
      "text": "Which purpose of the treaty between the United States and the Six Nations is not referenced in this 1801 speech?",
      "choices": [
        "the need to prevent unlawful acts",
        "the preservation of the written agreement",
    ...
    },
    {
      "number": 24,
      "part": "I",
      "text": "The speaker repeats the word “Brother” throughout the speech in order to",
      "choices": [
        ": 194–215 45 Regents Exam in ELA (Common Core) — Aug. ’14 5 10 15 20 Text 3 3 Reasons Why Hosting the Olympics Is a Loser’s Game THE OLYMPIC STIMULUS These days the summer Games might generate $5-to-6 billion in total revenue (nearly half of which goes to the International Olympic Committee). In contrast, the costs of the games rose to an estimated $16 billion in Athens, $40 billion in Beijing, and reportedly nearly $20 billion in London. Only some of this investment is tied up in infrastructure projects that may be useful going forward. The high costs are bound to make hosting the Olympics a bad deal in the short-run. Promoters, however, claim that there is a strong benefit that accrues over time connected to the advertising effect of hosting the games. The idea is that the hundreds of hours of television exposure to hundreds of millions of viewers around the globe will generate increased tourism and business for the city. ... It should be added that there is little evidence that tourism increases during the Games. Rather, Olympic tourists replace normal tourists who want to stay away to avoid the congestion and greater expense during the Games. Finally, it would appear that most of the positive developmental functions that could be associated with the Olympics, could also occur absent the Olympics. The needed infrastructural investments could be made, the national airline could offer reduced rates for stays of over one week, trade missions could multiply their efforts, and so on. Of course, it is always possible that a proactive, efficient government in a potential-laden, burgeoning city could use the Olympics to boost its fortunes. Barcelona ran up a reported $6 billion debt to host the 1992 Games, but the city’s image gained enormously and tourism has since flourished. The stars all aligned and Barcelona is arguably a case in point for Olympics promoters. Whether or not Barcelona would have experienced its favorable development without the Games, we’ll never know. —Andrew Zimbalist excerpted from “3 Reasons Why Hosting the Olympics Is a Loser’s Game” http://www.theatlantic.com, July 23, 2012 Regents Exam in ELA (Common Core) — Aug. ’14 Text 4 Factsheet: Legacies of the Games IOC [International Olympic Committee] SUPPORT As the Olympic Games have grown to become the world’s foremost sporting event, their impact on a host city and country has also increased. This has meant that cities interested in hosting the Games are now placing increasing emphasis on the legacies that such an event can create for their citizens and, in many cases, they are using the Games as a catalyst for urban renewal. ... GAMES OF THE OLYMPIAD BEIJING 2008 Education: 400 million children in 400,000 Chinese schools were exposed to the Olympic values, and 550 Chinese schools partnered with schools in other countries to conduct cultural sports and educational exchanges. ... Transport Infrastructure: Beijing’s Capital Airport saw its capacity increased by 24 million passengers; a new express way and high speed rail link was built to Tianjin; and three new subway lines were constructed, as well as a new ring road and airport express road. Public transport capacity was increased by 4.5 million people. Venues: Twenty-three of the Beijing 2008 venues will be used as sports facilities, conference centres and public event facilities; six venues were located on university campuses for use by students after the Games; and the International Broadcast Centre and Main Press Centre will serve conventions and tourism. ... Environment: Some 140 billion Yuan was invested in air quality improvements alone, with 60,000 coal-burning boilers being upgraded to reduce emissions; a number of public buses being converted to run on natural gas; and restrictions being put in place on private automobile use, a form of which is still in place today. There were also significant improvements in water treatment facilities. ATHENS 2004 Transport Infrastructure: Athens 2004 saw a new and renovated urban and underground system capable of carrying 1,000,000 passengers a day (20 per cent of the population of Athens); 90km of new roads were built and a further 120km widened, with a new computerised traffic management system installed to help manage traffic. A new airport was also constructed. ... Environment: Some 90 per cent of the Schinias rowing facility which is on reclaimed wetland was designated a wildlife preserve. Hundreds of thousands of trees and shrubs were planted. ... Education: One hundred thousand Greeks received technical, managerial or other Games-related training. ... Venues: Some Athens 2004 venues were converted for post-Games use, ranging from sports facilities to a local theatre, to shopping and convention centres, to Government offices and a new university campus. ... 5 10 15 20 25 30 Regents Exam in ELA (Common Core) — Aug. ’14 SALT LAKE CITY 2002... Venues: The Utah Athletic Foundation was created to manage the Olympic Oval and Park, allowing the local community to use the facilities, as well as host major events. Both the Park and Oval are USOC Olympic training sites. Fourteen venues in total continue to be used for events, elite training and recreational purposes. Education: The Salt Lake City Organising Committee provided Olympic-related experiences to 600,000 Utah school children and those experiences continue today with 5-10,000 students visiting Olympic facilities every year. Salt Lake also ran a “One School, One Country” programme partnering schools in Utah with schools in countries around the world, thus letting students learn about a variety of cultures, languages, customs, music and sport. Environment: Thanks to energy efficient designs, water conservation efforts, aquatic habitat restoration projects, recycling of Games waste, a worldwide tree planting programme and the encouragement of transit use, Salt Lake 2002 was certified as climate neutral by the Climate Neutral Network. ... LILLEHAMMER 1994 Environment: The Lillehammer Games were noteworthy for their focus on environmental conservation, which set the stage for the formation of the “Green” Olympics. Venues: Lillehammer Olympia Park AS was created to manage the legacy of five of the Olympic Venues. The Lillehammer Olympic venues are used for a host of purposes ranging from sporting to cultural and commercial events in both summer and winter. The venues are available for public use, as well as for elite athletes. In 2016, Lillehammer will host the Youth Olympic Games. ... Infrastructure: The Games allowed improvements to be made to the roads, the railway to Oslo, the local telecommunications system, and the water and sewage systems that would otherwise have taken 20 years. ... Education: The International Broadcast Centre allowed the Lillehammer College to increase enrolment from 600 to 3,000 students, thanks to the extra space it created. The local authority also developed an educational programme for local primary and secondary school students. ... —International Olympic Committee excerpted and adapted from “Factsheet: Legacies of the Games” July 17, 2012 35 40 45 50 55 60 Regents Exam in ELA (Common Core) — Aug. ’14 Part 3 Text-Analysis Response Your Task: Closely read the text provided on pages 20 and 21 and write a well-developed, text-based response of two to three paragraphs. In your response, identify a central idea in the text and analyze how the author’s use of one writing strategy (literary element or literary technique or rhetorical device) develops this central idea. Use strong and thorough evidence from the text to support your analysis. Do not simply summarize the text. You may use the margins to take notes as you read and scrap paper to plan your response. Write your response in the spaces provided on pages 7 through 9 of your essay booklet. Guidelines: Be sure to: • Identify a central idea in the text • Analyze how the author’s use of one writing strategy (literary element or literary technique or rhetorical device) develops this central idea. Examples include: characterization, conflict, denotation/connotation, metaphor, simile, irony, language use, point-of-view, setting, structure, symbolism, theme, tone, etc. • Use strong and thorough evidence from the text to support your analysis • Organize your ideas in a cohesive and coherent manner • Maintain a formal style of writing • Follow the conventions of standard written English Regents Exam in ELA (Common Core) — Aug. ’14 Text ...It turned out to be true. The face of the water [Mississippi River], in time, became a wonderful book—a book that was a dead language to the uneducated passenger, but which told its mind to me without reserve, delivering its most cherished secrets as clearly as if it uttered them with a voice. And it was not a book to be read once and thrown aside, for it had a new story to tell every day. Throughout the long twelve hundred miles there was never a page that was void of interest, never one that you could leave unread without loss, never one that you would want to skip, thinking you could find higher enjoyment in some other thing. There never was so wonderful a book written by man; never one whose interest was so absorbing, so unflagging, so sparklingly renewed with every reperusal. The passenger who could not read it was charmed with a peculiar sort of faint dimple on its surface (on the rare occasions when he did not overlook it altogether); but to the pilot that was an italicized passage; indeed, it was more than that, it was a legend of the largest capitals, with a string of shouting exclamation points at the end of it, for it meant that a wreck or a rock was buried there that could tear the life out of the strongest vessel that ever floated. It is the faintest and simplest expression the water ever makes, and the most hideous to a pilot’s eye. In truth, the passenger who could not read this book saw nothing but all manner of pretty pictures in it, painted by the sun and shaded by the clouds, whereas to the trained eye these were not pictures at all, but the grimmest and most dead-earnest of reading matter. Now when I had mastered the language of this water, and had come to know every trifling feature that bordered the great river as familiarly as I knew the letters of the alphabet, I had made a valuable acquisition. But I had lost something, too. I had lost something which could never be restored to me while I lived. All the grace, the beauty, the poetry, had gone out of the majestic river! I still kept in mind a certain wonderful sunset which I witnessed when steamboating was new to me. A broad expanse of the river was turned to blood; in the middle distance the red hue brightened into gold, through which a solitary log came floating, black and conspicuous; one place a long, slanting mark lay sparkling upon the water; in another the surface was broken by boiling, tumbling rings, that were as many- tinted as an opal; where the ruddy flush was faintest, was a smooth spot that was covered with graceful circles and radiating lines, ever so delicately traced; the shore on our left was densely wooded, and the sombre shadow that fell from this forest was broken in one place by a long, ruffled trail that shone like silver; and high above the forest wall a clean-stemmed dead tree waved a single leafy bough that glowed like a flame in the unobstructed splendor that was flowing from the sun. There were graceful curves, reflected images, woody heights, soft distances; and over the whole scene, far and near, the dissolving lights drifted steadily, enriching it every passing moment with new marvels of coloring. I stood like one bewitched. I drank it in, in a speechless rapture. The world was new to me, and I had never seen any thing like this at home. But as I have said, a day came when I began to cease from noting the glories and the charms which the moon and the sun and the twilight wrought upon the river’s face; another day came when I ceased altogether to note them. Then, if that sunset scene had been repeated, I should have looked upon it without rapture, and should have commented upon it, inwardly, after this fashion: “This sun means that we are going to have wind to-morrow; that floating log means that the river is rising, small thanks to it; that slanting mark on the water refers to a bluff reef which is going to kill somebody’s steamboat one of these nights, if it keeps on stretching out like that; those tumbling ‘boils’ show a dissolving bar and a changing channel there; the lines and circles in the slick water over yonder are a warning that that troublesome place is shoaling up dangerously; that silver streak in the shadow of the forest is the ‘break’ from a new snag, and he has located himself in the very best place he could have found to fish for steamboats; that tall dead tree, with a single living branch, is not going to last long, and then how is a body 5 10 15 20 25 30 35 40 45 50 Regents Exam in ELA (Common Core) — Aug. ’14 ever going to get through this blind place at night without the friendly old landmark?” No, the romance and the beauty were all gone from the river. All the value any feature of it had for me now was the amount of usefulness it could furnish toward compassing the safe piloting of a steamboat. Since those days, I have pitied doctors from my heart. What does the lovely flush in a beauty’s cheek mean to a doctor but a “break” that ripples above some deadly disease? Are not all her visible charms sown thick with what are to him the signs and symbols of hidden decay? Does he ever see her beauty at all, or doesn’t he simply view her professionally, and comment upon her unwholesome condition all to himself? And doesn’t he sometimes wonder whether he has gained most or lost most by learning his trade? —Mark Twain excerpted and adapted from Life on the Mississippi, 1901 Harper & Brothers Publishers 55 60 REGENTS IN ELA (Common Core) REGENTS IN ELA (Common Core) Printed on Recycled Paper",
        "establish a feeling of alliance",
