...
export function usePracticeTest(questionSet) {
  ...
  const grade = score >= 85 ? 'Mastery' : score >= 65 ? 'Passing' : 'Not Yet Passing'
  ...
  return { current, index, total, answers, phase, elapsedStr, answer, next, goTo, correct, score, grade, questions }
}
