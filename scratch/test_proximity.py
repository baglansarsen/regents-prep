...
if all_elements:
    ...
    for b in blocks:
        ...
        # Calculate gap-based vertical distance
        if ty0 >= ry1:
            v_dist = ty0 - ry1
        elif ty1 <= ry0:
            v_dist = ry0 - ty1
        ...
        # Use vertical gap limit of 30 points and horizontal gap limit of 50 points
    ...
    print(f"New Gap-Based Crop Box: cy0={cy0:.2f}, cy1={cy1:.2f}, cx0={cx0:.2f}, cx1={cx1:.2f}")
